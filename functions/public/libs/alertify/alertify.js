...
(function (window) {
  ...
  var on = function (el, event, fn, useCapture, passive) {
    el.addEventListener(
      event,
      fn,
      IsPassiveSupported ? { capture: useCapture, passive: passive } : useCapture === true,
    );
  };
      ...
      if (!instance.isMaximized()) {
        ...
        if (eventSrc) {
          ...
          element.style.minHeight =
            instance.elements.header.offsetHeight + instance.elements.footer.offsetHeight + 'px';
      ...
      setting: function (key, value) {
        ...
        if (result.op === 'get') {
          if (result.found) {
            ...
            return update(this, this.settings, this.settingUpdated || function () {}, key, value)
              .value;
          } else {
            return undefined;
          }
  ...
  var notifier = (function () {
      ...
      return initialize({
        ...
        delay: function (wait) {
          ...
          this.__internal.delay =
            typeof wait !== 'undefined' && !isNaN(+wait) ? +wait : notifier.__internal.delay;
    ...
    return {
      ...
      create: function (type, callback) {
        ...
        div.className =
          classes.message +
          (typeof type === 'string' && type !== '' ? ' ' + classes.prefix + type : '');
