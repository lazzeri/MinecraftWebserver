        ...
        if (Array.isArray(e)) {
          ...
          return (
            ...
            Array.isArray(e.data) &&
              ...
              e.fields || (e.fields = Array.isArray(e.data[0]) ? e.fields : h(e.data[0])),
      ...
      return (
        this.each(function (e) {
          ...
          for (var t = 0; t < this.files.length; t++)
            h.push({ file: this.files[t], inputElem: this, instanceConfig: d.extend({}, r) });
        }),
        e(),
        this
      );
    ...
    ((this._handle = null),
      ...
      (this.parseChunk = function (e, t) {
        ...
        if (!this._handle.paused() && !this._handle.aborted()) {
          var s = n.meta.cursor;
          (this._finished ||
            ((this._partialLine = i.substring(s - this._baseIndex)), (this._baseIndex = s)),
          ...
          if (o) f.postMessage({ results: n, workerId: b.WORKER_ID, finished: a });
            ...
            if (
              (this._config.chunk(n, this._handle), this._handle.paused() || this._handle.aborted())
            )
      ...
      (this._readChunk = function () {
        if (this._finished) this._chunkLoaded();
          ...
          if (
            ...
            n || ((i.onload = y(this._chunkLoaded, this)), (i.onerror = y(this._chunkError, this))),
  ...
  function r(g) {
      ...
      if (
        (c &&
          ...
          (k(
            ...
            "Unable to auto-detect delimiting character; defaulted to '" + b.DefaultDelimiter + "'",
          ),
          (h = !1)),
        g.skipEmptyLines)
      )
              ...
              g.header &&
                (r > l.length
                  ? k(
                      'FieldMismatch',
                      'TooManyFields',
                      'Too many fields: expected ' + l.length + ' fields but parsed ' + r,
                      f + t,
                    )
                  : r < l.length &&
                    k(
                      'FieldMismatch',
                      'TooFewFields',
                      'Too few fields: expected ' + l.length + ' fields but parsed ' + r,
                      f + t,
                    )),
              i
            );
    ...
    ((this.parse = function (e, t, r) {
      ...
      if (
        ...
        q(g.delimiter) && ((g.delimiter = g.delimiter(e)), (c.meta.delimiter = g.delimiter));
      else {
        var n = (function (e, t, r, i, n) {
          ...
          for (var u = 0; u < n.length; u++) {
            ...
            o = void 0;
            for (
              var p = new E({ comments: i, delimiter: f, newline: t, preview: 10 }).parse(e), m = 0;
              m < p.data.length;
              m++
            )
              if (r && v(p.data[m])) c++;
    ...
    ((this.parse = function (a, r, t) {
      ...
      function R(e, t) {
        return {
          data: t || !1 ? h[0] : h,
          errors: u,
          meta: { delimiter: D, linebreak: I, aborted: j, truncated: !!e, cursor: d + (r || 0) },
        };
      }
      function S() {
        (A(R(void 0, !0)), (h = []), (u = []));
