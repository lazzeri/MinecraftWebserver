...
DomBodies.init = function (Matter) {
  ...
  DomBodies.create = function (options) {
    ...
    var render = overlayObj.render; // Required
    ...
    options.domRenderer = overlayObj.render;

    var worldBody = null;
    var domBody = $('#' + options.Dom.element).get(0);
  ...
  DomBodies.block = function (x, y, options) {
    ...
    var element = $('#' + options.Dom.element).get(0);
    ...
    let test = updateObj(options, block);
    var body = DomBody.create(test);
  ...
  DomBodies.circle = function (x, y, radius, options, maxSides) {
    ...
    return DomBodies.polygon(x, y, sides, radius, updateObj(options, circle));
  };
  ...
  DomBodies.polygon = function (x, y, sides, radius, options) {
    ...
    return DomBody.create(updateObj(options, polygon));
  };
