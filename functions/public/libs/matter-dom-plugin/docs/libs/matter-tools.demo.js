...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object')
    module.exports = factory(
      require('functions/public/libs/matter-dom-plugin/docs/libs/matter'),
      require('MatterTools'),
    );
  else if (typeof define === 'function' && define.amd)
    define(['functions/public/libs/matter-dom-plugin/docs/libs/matter', 'MatterTools'], factory);
    ...
    ((root['MatterTools'] = root['MatterTools'] || {}),
      (root['MatterTools']['Demo'] = factory(root['Matter'], root['MatterTools'])));
  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Demo._isIOS =
          window.navigator && /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream;
        ...
        Demo.start = function (demo, initalExampleId) {
          initalExampleId =
            typeof initalExampleId === 'string' ? initalExampleId : demo.examples[0].id;
        ...
        Demo._createDom = function (options) {
          ...
          var exampleOptions = options.examples
