...
!(function (t, e) {
  ...
  class di extends Ze {
    ...
    removeEventListener(t, e) {
      const i = t.$proxies || (t.$proxies = {}),
        n = i[e];
      if (!n) return;
      ((({ attach: ci, detach: ci, resize: ci })[e] || ii)(t, e, n), (i[e] = void 0));
    }
    getDevicePixelRatio() {
  ...
  const fi = (t) => 0 === t || 1 === t,
    ...
    mi = {
      ...
      easeInOutElastic(t) {
        const e = 0.1125;
        return fi(t) ? t : t < 0.5 ? 0.5 * gi(2 * t, e, 0.45) : 0.5 + 0.5 * pi(2 * t - 1, e, 0.45);
      },
      easeInBack(t) {
        const e = 1.70158;
        return t * t * ((e + 1) * t - e);
      ...
      easeInOutBounce: (t) =>
        t < 0.5 ? 0.5 * mi.easeInBounce(2 * t) : 0.5 * mi.easeOutBounce(2 * t - 1) + 0.5,
    },
    xi = 'transparent',
    bi = {
  ...
  class Ri {
    ...
    applyStack(t, e, i) {
      const n = this.chart,
        o = this._cachedMeta,
        s = e[t.axis];
      return ki({ keys: Mi(n, !0), values: e._stacks[t.axis] }, s, o.index, { mode: i });
    }
    ...
    calculateLabelRotation() {
      ...
      ((a = e.offset ? t.maxWidth / n : f / (n - 1)),
        d + 6 > a &&
          ...
          (r = t.maxHeight - $i(e.grid) - i.padding - Yi(e.title, t.chart.options.font)),
          (l = Math.sqrt(d * d + u * u)),
          (c = It(
            Math.min(
      ...
      const {
        ...
        return (
          t.isHorizontal()
            ...
            : ((h = Hi(t, i, e)), (d = o(n, r, s)), (u = 'left' === i ? -Mt : Mt)),
      ...
      (function (t, e) {
        ...
        for (i = 0, n = t.length; i < n; ++i)
          ((a = s),
            ...
            s &&
              ((o = t[i]),
              a && ((o.cp1x = fn(o.cp1x, e.left, e.right)), (o.cp1y = fn(o.cp1y, e.top, e.bottom))),
              r &&
                ((o.cp2x = fn(o.cp2x, e.left, e.right)), (o.cp2y = fn(o.cp2y, e.top, e.bottom)))));
      })(t, i);
  }
  function pn(t, e, i, n) {
      ...
      ((m = e[t % a]),
        m.skip ||
          ...
          p !== x &&
            ...
            null !== _ &&
              v() &&
              (g.push(wn({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)),
            (i = t),
            (x = p))));
    return (null !== _ && g.push(wn({ start: _, end: d, loop: u, count: a, style: f })), g);
  }
  function kn(t, e) {
    const i = [],
      n = t.segments;
          ...
          for (const r of t) {
            ...
            for (a = s + 1; a <= r.end; a++) {
              ...
              ((l = Dn(i.setContext({ type: 'segment', p0: c, p1: h }))),
                Cn(l, t) &&
                  (o.push({ start: s, end: a - 1, loop: r.loop, style: t }), (t = l), (s = a - 1)),
                (c = h),
                (t = l));
            }
      ...
      return !1 !== n || e
        ? (function (t, e, i, n) {
            ...
            for (let a = 0; a < e.length; a++) {
              const r = e[a],
                l = Rn(i[r.id], n);
              null !== l && o.push({ plugin: r, options: En(t.config, r, l, s) });
            }
            return o;
          })(t, o, n, e)
        : [];
  ...
  function Zn(t) {
    return (
      Gn() && 'string' == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]),
  ...
  class to {
    ...
    _initializePlatform(t, e) {
      return e.platform
        ? new e.platform()
        : !Gn() || ('undefined' != typeof OffscreenCanvas && t instanceof OffscreenCanvas)
          ? new Qe()
          : new di();
    }
    clear() {
      ...
      (i &&
        ...
        J(s, (i) => {
          ...
          if (a in n && n[a].type === l) c = n[a];
            ...
            ((c = new (Tn.getScale(l))({ id: a, type: l, ctx: t.ctx, chart: t })), (n[c.id] = c));
          }
          c.init(s, e);
        }),
        J(o, (t, e) => {
    ...
    render() {
      ...
      !1 !== t.notifyPlugins('beforeRender', { cancelable: !0 }) &&
        (a.has(t) ? t.attached && !a.running(t) && a.start(t) : (t.draw(), qn({ chart: t })));
    }
    draw() {
      const t = this;
      let e;
    ...
    updateElements(t, e, i, n) {
      ...
      for (let l = e; l < e + i; l++) {
        ...
        ((c.skip = isNaN(f) || isNaN(g)),
          h && ((c.options = o.resolveDataElementOptions(l, n)), s && (c.options.radius = 0)),
    ...
    update(t) {
      ...
      let { start: r, count: l } = (function (t, e, i) {
        ...
        if (t._sorted) {
          ...
          (d &&
            (o = Nt(
              Math.min(oe(r, a.axis, c).lo, i ? n : oe(e, l, a.getPixelForValue(c)).lo),
              0,
              n - 1,
            )),
            (s = u
              ? Nt(
                  Math.max(oe(r, a.axis, h).hi + 1, i ? 0 : oe(e, l, a.getPixelForValue(h)).hi + 1),
                  o,
                  n,
                ) - o
              : n - o));
  ...
  ((go.id = 'line'),
    ...
    (go.overrides = { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } }));
  class po extends Ri {
    constructor(t, e) {
  ...
  ((xo.id = 'radar'),
    ...
    (xo.overrides = { aspectRatio: 1, scales: { r: { type: 'radialLinear' } } }));
  class bo extends go {}
  ((bo.id = 'scatter'),
  ...
  function Mo(t, e, i) {
    const { x: n, y: o, startAngle: s, endAngle: a, pixelMargin: r, innerRadius: l } = e,
      ...
      f = s + u,
      g = a - u,
      { outerStart: p, outerEnd: m, innerStart: x, innerEnd: b } = vo(e, h, c, g - f),
      _ = c - p,
      y = c - m,
      v = f + p / _,
      w = g - m / y,
        ...
        (function (t, e, i) {
          ...
          for (
            i &&
              ...
              yo(t, e),
              (e.endAngle = a),
              e.endAngle === e.startAngle && ((e.endAngle += _t), e.fullCircles--)),
              t.beginPath(),
    ...
    draw(t) {
      ...
      ((t.fillStyle = i.backgroundColor),
        ...
        (function (t, e, i) {
          ...
          (isNaN(e.circumference) || (e.endAngle = e.startAngle + (e.circumference % _t)),
            Mo(t, e, i),
            t.fill());
        })(t, e, o),
        ko(t, e, o),
  ...
  ((Eo.id = 'line'),
    ...
    (Eo.descriptors = { _scriptable: !0, _indexable: (t) => 'borderDash' !== t && 'fill' !== t }));
  class zo extends Ei {
    constructor(t) {
      (super(),
        (this.options = void 0),
  ...
  function Bo(t, e, i, n) {
    ...
    return (
      n
        ? ((a = i), (t = Wo((t = (o = t) === (s = e) ? a : o === a ? s : o), i, e)))
        : (t = Wo(t, e, i)),
      t
    );
  }
  ...
  ((zo.id = 'point'),
    ...
    (zo.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }));
  class Yo extends Ei {
    constructor(t) {
      (super(),
        (this.options = void 0),
  ...
  ((Yo.id = 'bar'),
    ...
    (Yo.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' }));
      ...
      ? (function (t) {
          ...
          if (
            ...
            return (
              ...
              new Zo({ x: c.x, y: c.y, radius: e.getDistanceFromCenterForValue(h) })
            );
  ...
  function ns(t, e) {
    ...
    return (
      ...
      i.length ? new Eo({ points: i, options: { tension: 0 }, _loop: n, _fullLoop: n }) : null
    );
  }
  function os(t, e, i) {
    let n = t[e].fill;
      ...
      (t.legendItems.forEach((e, M) => {
        ...
        (h.setWidth(t.width),
          y
            ? M > 0 &&
              D + P + f > t.right &&
              ((C = m.y += w), m.line++, (D = m.x = o(r, t.left + f, t.right - n[m.line])))
            : M > 0 &&
              C + w > t.bottom &&
        ...
        (!(function (t, e, i) {
          ...
          (D = s(S, D + x + p, t.right)),
          (function (t, e, i) {
            ee(a, i.text, t, e + _ / 2, d, { strikethrough: i.hidden, textAlign: i.textAlign });
          })(h.x(D), C, e),
          y ? (m.x += P + f) : (m.y += w));
      }),
  ...
  class Rs extends Xi {
    ...
    parse(t, e) {
      ...
      return ((t, e) => (null === t ? null : Nt(Math.round(t), 0, e)))(
        (e = isFinite(e) && i[e] === t ? e : Ls(i, t, K(e, t))),
        i.length - 1,
      );
    }
    determineDataLimits() {
      ...
      const o = (function (t, e) {
        ...
        ((w = Math.ceil(g / M) - Math.floor(f / M)),
          ...
          p && m && n && Lt((s - o) / n, M / 1e3)
            ? ((w = Math.min((s - o) / M, l)), (M = (s - o) / w), (y = o), (v = s))
            : x
              ? ((y = p ? o : y), (v = m ? s : v), (w = r - 1), (M = (v - y) / w))
              : ((w = (v - y) / M),
                (w = Tt(w, Math.round(w), M / 1e3) ? Math.round(w) : Math.ceil(w))));
  ...
  ((Vs.id = 'logarithmic'),
    (Vs.defaults = { ticks: { callback: Vi.formatters.logarithmic, major: { enabled: !0 } } }));
  class Ys extends Is {
    constructor(t) {
      (super(t),
        (this.xCenter = void 0),
  ...
  function Ks(t, e) {
    ...
    return (
      ...
      null === a
        ...
        : (o &&
            (a =
              'week' !== o || (!At(s) && !0 !== s) ? i.startOf(a, o) : i.startOf(a, 'isoWeek', s)),
          +a)
    );
  }
  function Gs(t, e, i, n) {
