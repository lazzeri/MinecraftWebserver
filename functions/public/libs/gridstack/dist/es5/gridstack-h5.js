    ...
    var t = {
          ...
          ((e.GridStackDD = d),
            (a.GridStack.prototype._setupAcceptWidget = function () {
              ...
              var n = function (n, r, s) {
                var a = r.gridstackNode;
                if (a) {
                  var h = (s = s || r).getBoundingClientRect(),
                    p = h.left - t.left,
                    u = h.top - t.top,
                    c = { position: { top: u, left: p } };
                  if (a._temporaryRemoved) {
                    if (
                      ((a.x = Math.max(0, Math.round(p / i))),
                      (a.y = Math.max(0, Math.round(u / e))),
                      delete a.autoPosition,
                      o.engine.nodeBoundFix(a),
                      !o.engine.willItFit(a))
                    ) {
                      if (((a.autoPosition = !0), !o.engine.willItFit(a)))
                        return void d.get().off(r, 'drag');
                      a._willFitPos && (l.Utils.copyPos(a, a._willFitPos), delete a._willFitPos);
                    }
                    o._onStartMoving(s, n, c, a, i, e);
                  } else o._dragOrResize(s, n, c, a, i, e);
                }
              };
              return (
                d
                  ...
                  .droppable(this.el, {
                    accept: function (t) {
                      ...
                      if ((null == e ? void 0 : e.grid) === o) return !0;
                      if (!o.opts.acceptWidgets) return !1;
                      var i = !0;
                      if ('function' == typeof o.opts.acceptWidgets) i = o.opts.acceptWidgets(t);
                      else {
                        var n =
                          !0 === o.opts.acceptWidgets ? '.grid-stack-item' : o.opts.acceptWidgets;
                        i = t.matches(n);
                      }
                      if (i && e && o.opts.maxRow) {
                        var r = { w: e.w, h: e.h, minW: e.minW, minH: e.minH };
                        i = o.engine.willItFit(r);
                      }
                      return i;
                    },
                  })
                  .on(this.el, 'dropover', function (s, a, l) {
                    var p = a.gridstackNode;
                    if ((null == p ? void 0 : p.grid) === o && !p._temporaryRemoved) return !1;
                    (null == p ? void 0 : p.grid) &&
                      p.grid !== o &&
                      !p._temporaryRemoved &&
                      p.grid._leave(a, l);
                    var u = o.el.getBoundingClientRect();
                    ((t = { top: u.top, left: u.left }),
                      (i = o.cellWidth()),
                      (e = o.getCellHeight(!0)),
                      p || (p = o._readAttr(a)),
                      p.grid || ((p._isExternal = !0), (a.gridstackNode = p)),
                      (l = l || a));
                    var c = p.w || Math.round(l.offsetWidth / i) || 1,
                      g = p.h || Math.round(l.offsetHeight / e) || 1;
                    return (
                      p.grid && p.grid !== o
                        ? (a._gridstackNodeOrig || (a._gridstackNodeOrig = p),
                          (a.gridstackNode = p = r(r({}, p), { w: c, h: g, grid: o })),
                          o.engine.cleanupNode(p).nodeBoundFix(p),
                          (p._initDD = p._isExternal = p._temporaryRemoved = !0))
                        : ((p.w = c), (p.h = g), (p._temporaryRemoved = !0)),
                      h(p.el, !1),
                      d.get().on(a, 'drag', n),
                      n(s, a, l),
                      !1
                  ...
                  .on(this.el, 'dropout', function (t, e, i) {
                    ...
                    return !!n && ((n.grid && n.grid !== o) || o._leave(e, i), !1);
                  })
                  .on(this.el, 'drop', function (t, e, i) {
                    var n = e.gridstackNode;
                    if ((null == n ? void 0 : n.grid) === o && !n._isExternal) return !1;
                    var s = !!o.placeholder.parentElement;
                    o.placeholder.remove();
                    var a = e._gridstackNodeOrig;
                    if ((delete e._gridstackNodeOrig, s && a && a.grid && a.grid !== o)) {
                      var h = a.grid;
                      (h.engine.removedNodes.push(a), h._triggerRemoveEvent());
                    }
                    return (
                      !!n &&
                      (s && (o.engine.cleanupNode(n), (n.grid = o)),
                      d.get().off(e, 'drag'),
                      i !== e
                        ? (i.remove(), (e.gridstackNode = a), s && (e = e.cloneNode(!0)))
                        : (e.remove(), d.get().remove(e)),
                      !!s &&
                        ((e.gridstackNode = n),
                        (n.el = e),
                        l.Utils.copyPos(n, o._readAttr(o.placeholder)),
                        l.Utils.removePositioningStyles(e),
                        o._writeAttr(e, n),
                        o.el.appendChild(e),
                        o._updateContainerHeight(),
                        o.engine.addedNodes.push(n),
                        o._triggerAddEvent(),
                        o._triggerChangeEvent(),
                        o.engine.endUpdate(),
                        o._gsEventHandler.dropped &&
                          o._gsEventHandler.dropped(
                            r(r({}, t), { type: 'dropped' }),
                            a && a.grid ? a : void 0,
                            n,
            ...
            (a.GridStack.prototype._prepareDragDropByNode = function (t) {
              ...
              if (
                ...
                return (
                  t._initDD && (o.remove(i), delete t._initDD),
              ...
              if (!t._initDD) {
                var n,
                  ...
                  s = function (o, s) {
                    (e._gsEventHandler[o.type] && e._gsEventHandler[o.type](o, o.target),
                      (n = e.cellWidth()),
                      (r = e.getCellHeight(!0)),
                      e._onStartMoving(i, o, s, t, n, r));
                  },
                  a = function (o, s) {
                    e._dragOrResize(i, o, s, t, n, r);
                  },
                  h = function (n) {
                    ...
                    if (r.gridstackNode && r.gridstackNode.grid === e) {
                      if (((t.el = r), t._isAboutToRemove)) {
                        ...
                        (s._gsEventHandler[n.type] && s._gsEventHandler[n.type](n, r),
                          o.remove(i),
                          s.engine.removedNodes.push(t),
                        ...
                        (t._temporaryRemoved
                          ? (l.Utils.removePositioningStyles(r),
                            l.Utils.copyPos(t, t._orig),
                            e._writePosAttr(r, t),
                            e.engine.addNode(t))
                          : (l.Utils.removePositioningStyles(r), e._writePosAttr(r, t)),
                          e._gsEventHandler[n.type] && e._gsEventHandler[n.type](n, r));
                      ((e._extraDragRow = 0),
                ...
                (o
                  .draggable(i, { start: s, stop: h, drag: a })
                  .resizable(i, { start: s, stop: h, resize: a }),
                  (t._initDD = !0));
              }
              return (
                t.noMove || this.opts.disableDrag
                  ? (o.draggable(i, 'disable'), i.classList.add('ui-draggable-disabled'))
                  : (o.draggable(i, 'enable'), i.classList.remove('ui-draggable-disabled')),
                t.noResize || this.opts.disableResize
                  ? (o.resizable(i, 'disable'), i.classList.add('ui-resizable-disabled'))
                  : (o.resizable(i, 'enable'), i.classList.remove('ui-resizable-disabled')),
                this
              );
            }),
            (a.GridStack.prototype._onStartMoving = function (t, e, i, o, n, r) {
              if (
                ...
                var s = d
                  .get()
                  .resizable(t, 'option', 'minWidth', n * (o.minW || 1))
                  .resizable(t, 'option', 'minHeight', r * (o.minH || 1));
                (o.maxW && s.resizable(t, 'option', 'maxWidth', n * o.maxW),
                  o.maxH && s.resizable(t, 'option', 'maxHeight', r * o.maxH));
              }
            }),
            ...
            (a.GridStack.prototype._dragOrResize = function (t, e, i, o, n, s) {
              var a,
                d = r({}, o._orig),
                h = this.opts.marginLeft,
                p = this.opts.marginRight,
                u = this.opts.marginTop,
              ...
              if (
                ...
                var m = i.position.top - o._prevYPix;
                ((o._prevYPix = i.position.top), l.Utils.updateScrollPosition(t, i.position, m));
                var v = i.position.left + (i.position.left > o._lastUiPosition.left ? -p : h),
                  y = i.position.top + (i.position.top > o._lastUiPosition.top ? -c : u);
                ((d.x = Math.round(v / n)), (d.y = Math.round(y / s)));
                var _ = this._extraDragRow;
                if (this.engine.collide(o, d)) {
                  var b = this.getRow(),
                    w = Math.max(0, d.y + o.h - b);
                  (this.opts.maxRow &&
                    b + w > this.opts.maxRow &&
                    (w = Math.max(0, this.opts.maxRow - b)),
                    (this._extraDragRow = w));
                } else this._extraDragRow = 0;
                if (
                  (this._extraDragRow !== _ && this._updateContainerHeight(),
                  o.x === d.x && o.y === d.y)
                )
                  return;
                ...
                if (d.x < 0) return;
                if (
                  (l.Utils.updateScrollResize(e, t, s),
                  (d.w = Math.round((i.size.width - h) / n)),
                  (d.h = Math.round((i.size.height - u) / s)),
                  o.w === d.w && o.h === d.h)
                )
                  return;
                if (o._lastTried && o._lastTried.w === d.w && o._lastTried.h === d.h) return;
                v = i.position.left + h;
                var E = i.position.top + u;
                ((d.x = Math.round(v / n)), (d.y = Math.round(E / s)), (a = !0));
              }
              o._lastTried = d;
              var x = {
                x: i.position.left + h,
                y: i.position.top + u,
                w: (i.size ? i.size.width : o.w * n) - h - p,
                h: (i.size ? i.size.height : o.h * s) - u - c,
              };
              if (
                this.engine.moveNodeCheck(
                  o,
                  r(r({}, d), { cellWidth: n, cellHeight: s, rect: x, resizing: a }),
                )
              ) {
                ((o._lastUiPosition = i.position),
                  this.engine.cacheRects(n, s, u, p, c, h),
                  delete o._skipDown,
                  a && o.subGrid && o.subGrid.onParentResize(),
                  (this._extraDragRow = 0),
                  this._updateContainerHeight());
                var D = e.target;
                (this._writePosAttr(D, o),
                  this._gsEventHandler[e.type] && this._gsEventHandler[e.type](e, D));
              }
            }),
              ...
              return (
                this.opts.staticGrid ||
                  a.GridStack.getElements(t).forEach(function (t) {
                    var o = t.gridstackNode;
                    o && (e ? delete o.noMove : (o.noMove = !0), i._prepareDragDropByNode(o));
                  }),
                this
              );
            }),
            (a.GridStack.prototype.resizable = function (t, e) {
              ...
              return (
                this.opts.staticGrid ||
                  a.GridStack.getElements(t).forEach(function (t) {
                    var o = t.gridstackNode;
                    o && (e ? delete o.noResize : (o.noResize = !0), i._prepareDragDropByNode(o));
                  }),
                this
              );
            }),
            ...
            r = (function () {
              ...
              return (
                ...
                (t.prototype._useEntireRowArea = function (t, e) {
                  return (
                    !this.float && !this._hasLocked && (!t._moving || t._skipDown || e.y <= t.y)
                  );
                }),
                (t.prototype._fixCollisions = function (t, e, i, r) {
                  ...
                  this._useEntireRowArea(t, e) &&
                    ((s = { x: 0, w: this.column, y: e.y, h: e.h }),
                  ...
                  for (
                    ...
                    if (
                      ...
                      (t._moving &&
                        ...
                        e.y > t.y &&
                        !this.float &&
                        (!this.collide(i, o(o({}, i), { y: t.y }), t) ||
                          !this.collide(i, o(o({}, i), { y: e.y - i.h }), t)))
                        ? ((t._skipDown = t._skipDown || e.y > t.y),
                          (d = this.moveNode(t, o(o(o({}, e), { y: i.y + i.h }), l))),
                          i.locked && d
                            ? n.Utils.copyPos(e, t)
                            : !i.locked &&
                              d &&
                              r.pack &&
                              (this._packNodes(), (e.y = i.y + i.h), n.Utils.copyPos(t, e)),
                          (a = a || d))
                        : (d = this.moveNode(i, o(o(o({}, i), { y: e.y + e.h, skip: t }), l))),
                      !d)
                    )
                      return a;
                    i = void 0;
                ...
                (t.prototype.collideCoverage = function (t, e, i) {
                  if (e.rect && t._rect) {
                    var n,
                      ...
                      s = o({}, e.rect);
                    return (
                      s.y > r.y ? ((s.h += s.y - r.y), (s.y = r.y)) : (s.h += r.y - s.y),
                      s.x > r.x ? ((s.w += s.x - r.x), (s.x = r.x)) : (s.w += r.x - s.x),
                      i.forEach(function (t) {
                        if (!t.locked && t._rect) {
                          ...
                          (r.y < e.y
                            ? (i = (s.y + s.h - e.y) / e.h)
                            : r.y + r.h > e.y + e.h && (i = (e.y + e.h - s.y) / e.h),
                            r.x < e.x
                              ? (o = (s.x + s.w - e.x) / e.w)
                              : r.x + r.w > e.x + e.w && (o = (e.x + e.w - s.x) / e.w));
                          var l = Math.min(o, i);
                          l > a && ((a = l), (n = t));
                        }
                      }),
                ...
                (t.prototype.swap = function (t, e) {
                  ...
                  if (!1 !== o) {
                    ...
                    if (!1 !== o)
                      return (
                        !(t.h !== e.h || t.y !== e.y || (!o && !(o = n.Utils.isTouching(t, e)))) &&
                        (e.x < t.x && ((r = t), (t = e), (e = r)), i())
                      );
                  }
                }),
                (t.prototype.isAreaEmpty = function (t, e, i, o) {
                  var n = { x: t || 0, y: e || 0, w: i || 1, h: o || 1 };
                ...
                Object.defineProperty(t.prototype, 'float', {
                  ...
                  set: function (t) {
                    this._float !== t &&
                      ((this._float = t || !1), t || this._packNodes()._notify());
                  },
                  enumerable: !1,
                  configurable: !0,
                }),
                      ...
                      this.float
                        ...
                        : this.nodes.forEach(function (e, i) {
                            if (!e.locked)
                              for (; e.y > 0; ) {
                                var o = 0 === i ? 0 : e.y - 1;
                                if (0 !== i && t.collide(e, { x: e.x, y: o, w: e.w, h: e.h }))
                                  break;
                ...
                (t.prototype.addNode = function (t, e) {
                  ...
                  if (
                    ...
                    for (
                      var o = function (e) {
                          var i = e % r.column,
                            o = Math.floor(e / r.column);
                          if (i + t.w > r.column) return 'continue';
                          var s = { x: i, y: o, w: t.w, h: t.h };
                          return r.nodes.find(function (t) {
                            return n.Utils.isIntercepted(s, t);
                          })
                            ? void 0
                            : ((t.x = i), (t.y = o), delete t.autoPosition, 'break');
                        },
                        r = this,
                        s = 0;
                      'break' !== o(s);
                ...
                (t.prototype.moveNodeCheck = function (e, i) {
                  ...
                  var a = new t({
                    ...
                    nodes: this.nodes.map(function (t) {
                      return t === e ? (r = o({}, t)) : o({}, t);
                    }),
                  });
                  if (!r) return !1;
                  var l = a.moveNode(r, i);
                  if (this.maxRow && l && !(l = a.getRow() <= this.maxRow) && !i.resizing) {
                    var d = this.collide(e, i);
                    if (d && this.swap(e, d)) return (this._notify(), !0);
                  }
                  return (
                    !!l &&
                    (a.nodes
                ...
                (t.prototype.willItFit = function (e) {
                  ...
                  return (
                    ...
                    delete r.grid,
                    i.addNode(r),
                    i.getRow() <= this.maxRow && ((e._willFitPos = n.Utils.copyPos({}, r)), !0)
                  );
                }),
                ...
                (t.prototype.moveNode = function (t, e) {
                  ...
                  if (
                    ...
                    return !1;
                  var r = n.Utils.copyPos({}, t),
                    s = o,
                    a = this.collideAll(t, s, e.skip),
                    l = !0;
                  if (a.length) {
                    var d = t._moving && !e.nested ? this.collideCoverage(t, e, a) : a[0];
                    l = !!d && !this._fixCollisions(t, o, d, e);
                  }
                  return (
                    l && ((t._dirty = !0), n.Utils.copyPos(t, o)),
                  ...
                  return (
                    ...
                    this.nodes.forEach(function (e) {
                      var i =
                        ...
                        s = o({}, e);
                      for (var a in (i && ((s.x = i.x), (s.y = i.y), (s.w = i.w)), s))
                        ('_' !== a[0] && null !== s[a] && void 0 !== s[a]) || delete s[a];
                      (delete s.grid,
                        t || delete s.el,
                ...
                (t.prototype.layoutsNodesChange = function (t) {
                  ...
                  return (
                    !this._layouts ||
                      this._inColumnResize ||
                      this._layouts.forEach(function (i, o) {
                ...
                (t.prototype.updateNodeWidths = function (t, e, i, o) {
                  var r,
                    s = this;
                  if ((void 0 === o && (o = 'moveScale'), !this.nodes.length || !e || t === e))
                    return this;
                  ...
                  if (e > t) {
                    h = this._layouts[e] || [];
                    var p = this._layouts.length - 1;
                    !h.length &&
                      t !== p &&
                      (null === (r = this._layouts[p]) || void 0 === r ? void 0 : r.length) &&
                      ((t = p),
                  ...
                  if (
                    ...
                    if ('function' == typeof o) o(e, t, a, i);
                      ...
                      (i.forEach(function (i) {
                        ((i.x = 1 === e ? 0 : c ? Math.round(i.x * u) : Math.min(i.x, e - 1)),
                          (i.w =
                            1 === e || 1 === t
                              ? 1
                              : g
                  ...
                  return (
                    (a = n.Utils.sort(a, -1, e)),
                    (this._inColumnResize = !0),
                    (this.nodes = []),
                    a.forEach(function (t) {
                      (s.addNode(t, !1), delete t._orig);
                    }),
                    this.commit(),
                  ...
                  return (
                    e.forEach(function (e, i) {
                      ((e._id = e._id || t._idSeq++),
                        (n[i] = { x: e.x, y: e.y, w: e.w, _id: e._id }));
                    }),
                ...
                (t.prototype.cacheOneLayout = function (e, i) {
                  e._id = e._id || t._idSeq++;
                  var o = { x: e.x, y: e.y, w: e.w, _id: e._id };
                  ((this._layouts = this._layouts || []),
                    (this._layouts[i] = this._layouts[i] || []));
                  var n = this._layouts[i].findIndex(function (t) {
                    return t._id === e._id;
                  });
        ...
        324: function (t, e, i) {
            ...
            s =
              ...
              function () {
                ...
                var o = Array(t),
                  n = 0;
                for (e = 0; e < i; e++)
                  for (var r = arguments[e], s = 0, a = r.length; s < a; s++, n++) o[n] = r[s];
                return o;
              };
          ...
          var a = i(506),
            l = i(867),
            d = i(620);
          (r(i(855), e), r(i(867), e), r(i(506), e), r(i(620), e));
          var h = {
              column: 12,
              minRow: 0,
              maxRow: 0,
            ...
            p = (function () {
              function t(e, i) {
                ...
                var r = l.Utils.toNumber(e.getAttribute('gs-row')),
                  s = o(o({}, l.Utils.cloneDeep(h)), {
                    column: l.Utils.toNumber(e.getAttribute('gs-column')) || 12,
                    minRow: r || l.Utils.toNumber(e.getAttribute('gs-min-row')) || 0,
                    maxRow: r || l.Utils.toNumber(e.getAttribute('gs-max-row')) || 0,
                ...
                (e.getAttribute('gs-animate') &&
                  (s.animate = l.Utils.toBool(e.getAttribute('gs-animate'))),
                  (this.opts = l.Utils.defaults(i, s)),
                  (i = null),
                  this.initMargin(),
                  1 !== this.opts.column &&
                ...
                var d = l.Utils.closestByClass(this.el, h.itemClass);
                if (
                  (d &&
                    d.gridstackNode &&
                    ((this.opts._isNested = d.gridstackNode),
                  ...
                  this._isAutoCellHeight || 'initial' === this.opts.cellHeight
                    ...
                    : ('number' == typeof this.opts.cellHeight &&
                        ...
                        this.opts.cellHeightUnit !== h.cellHeightUnit &&
                  ...
                  (this.engine = new a.GridStackEngine({
                    ...
                    onChange: function (t) {
                      var e = 0;
                      (n.engine.nodes.forEach(function (t) {
                  ...
                  (this.getGridItems().forEach(function (t) {
                    ...
                    p.push({
                      el: t,
                      i: (Number.isNaN(e) ? 1e3 : e) + (Number.isNaN(i) ? 1e3 : i) * n.opts.column,
                    });
                  }),
                    p
                      .sort(function (t, e) {
              ...
              return (
                (t.init = function (e, i) {
                  ...
                  return o
                    ? (o.gridstack || (o.gridstack = new t(o, l.Utils.cloneDeep(e))), o.gridstack)
                    : ('string' == typeof i
                        ? console.error(
                ...
                (t.addGrid = function (e, i) {
                  ...
                  if (!e.classList.contains('grid-stack')) {
                    ...
                    ((n.body.innerHTML = '<div class="grid-stack ' + (i.class || '') + '"></div>'),
                      (o = n.body.children[0]),
                      e.appendChild(o));
                  }
                  var r = t.init(i, o);
                  if (r.opts.children) {
                    var s = r.opts.children;
                    (delete r.opts.children, r.load(s));
                  }
                  return r;
                }),
                ...
                (t.prototype.addWidget = function (e, i) {
                  ...
                  var a;
                  if ('string' == typeof e)
                    (((d = document.implementation.createHTMLDocument('')).body.innerHTML = e),
                      (a = d.body.children[0]));
                  else if (0 === arguments.length || (1 === arguments.length && s(e))) {
                    var d,
                      h = (e && e.content) || '';
                    ((i = e),
                      ((d = document.implementation.createHTMLDocument('')).body.innerHTML =
                  ...
                  var p = this._readAttr(a);
                  ((i = l.Utils.cloneDeep(i) || {}), l.Utils.defaults(i, p));
                  var u = this.engine.prepareNode(i);
                  return (
                    this._writeAttr(a, i),
                    ...
                    u.subGrid &&
                      !u.subGrid.el &&
                      ((h = u.el.querySelector('.grid-stack-item-content')),
                      (u.subGrid = t.addGrid(h, u.subGrid))),
                  ...
                  if (
                    ...
                    return (
                      o.marginBottom === o.marginTop &&
                        ...
                        delete o.marginLeft),
                      o.rtl === ('rtl' === this.el.style.direction) && (o.rtl = 'auto'),
                      this._isAutoCellHeight && (o.cellHeight = 'auto'),
                      l.Utils.removeInternalAndSame(o, h),
                      (o.children = i),
                      o
                    );
                  }
                ...
                (t.prototype.load = function (e, i) {
                  var o = this;
                  void 0 === i && (i = !0);
                  var n = t.Utils.sort(s(e), -1, this._prevColumn || this.opts.column);
                  ((this._insertNotAppend = !0),
                    this._prevColumn &&
                      ...
                      this.engine.cacheLayout(n, this._prevColumn, !0)));
                  var r = [];
                  return (
                    this.batchUpdate(),
                    i &&
                      s(this.engine.nodes).forEach(function (t) {
                        n.find(function (e) {
                          return t.id === e.id;
                        }) ||
                          ('function' == typeof i
                            ? i(o, t, !1)
                            : (r.push(t), o.removeWidget(t.el, !0, !1)));
                      }),
                    n.forEach(function (t) {
                      var e =
                        t.id || 0 === t.id
                          ? o.engine.nodes.find(function (e) {
                              return e.id === t.id;
                            })
                          : void 0;
                      if (e) {
                        if ((o.update(e.el, t), t.subGrid && t.subGrid.children)) {
                          ...
                          n &&
                            n.gridstack &&
                            (n.gridstack.load(t.subGrid.children), (o._insertNotAppend = !0));
                        }
                      } else
                        i &&
                          (t =
                            'function' == typeof i
                              ? i(o, t, !0).gridstackNode
                              : o.addWidget(t).gridstackNode);
                    }),
                ...
                (t.prototype.cellHeight = function (t, e) {
                  ...
                  return (
                    (this.opts.cellHeightUnit === o.unit && this.opts.cellHeight === o.h) ||
                ...
                (t.prototype.column = function (t, e) {
                  ...
                  var i,
                    o = this.opts.column;
                  return (
                    1 === t ? (this._prevColumn = o) : delete this._prevColumn,
                    this.el.classList.remove('grid-stack-' + o),
                    ...
                    1 === t &&
                      ...
                      i.length || (i = void 0)),
                    this.engine.updateNodeWidths(o, t, i, e),
                ...
                (t.prototype.getCellFromPixel = function (t, e) {
                  ...
                  i = e
                    ? { top: o.top + document.documentElement.scrollTop, left: o.left }
                    : { top: this.el.offsetTop, left: this.el.offsetLeft };
                  var n = t.left - i.left,
                    r = t.top - i.top,
                    s = o.width / this.opts.column,
                ...
                (t.prototype.removeWidget = function (e, i, o) {
                  ...
                  return (
                    ...
                    t.getElements(e).forEach(function (t) {
                      if (t.parentElement === n.el) {
                        var e = t.gridstackNode;
                        (e ||
                          (e = n.engine.nodes.find(function (e) {
                            return t === e.el;
                          })),
                          e &&
                            (delete t.gridstackNode,
                            d.GridStackDDI.get().remove(t),
                            n.engine.removeNode(e, i, o),
                            i && t.parentElement && t.remove()));
                      }
                    }),
                    o && (this._triggerRemoveEvent(), this._triggerChangeEvent()),
                    this
                  );
                }),
                (t.prototype.removeAll = function (t) {
                  return (
                    ...
                    this.engine.nodes.forEach(function (t) {
                      (delete t.el.gridstackNode, d.GridStackDDI.get().remove(t.el));
                    }),
                        ...
                        if (
                          (s.some(function (t) {
                            ...
                            s.forEach(function (t) {
                              ((r[t] = void 0 !== n[t] ? n[t] : e[t]), delete n[t]);
                            })),
                          !r && (n.minW || n.minH || n.maxW || n.maxH) && (r = {}),
                          n.content)
                        ) {
                          var a = t.querySelector('.grid-stack-item-content');
                          (a && a.innerHTML !== n.content && (a.innerHTML = n.content),
                            delete n.content);
                        }
                        var d = !1,
                          h = !1;
                        for (var p in n)
                          '_' !== p[0] &&
                            ...
                            (h =
                              h ||
                              (!o.opts.staticGrid &&
                                ('noResize' === p || 'noMove' === p || 'locked' === p))));
                        (r &&
                          (o.engine.cleanNodes().beginUpdate(e).moveNode(e, r),
                          o._updateContainerHeight(),
                          o._triggerChangeEvent(),
                          o.engine.endUpdate()),
                          d && o._writeAttr(t, e),
                          h && o._prepareDragDropByNode(e));
                      }
                    }),
                    this
                  );
                ...
                (t.prototype._removeStylesheet = function () {
                  return (
                    this._styles &&
                      (l.Utils.removeStylesheet(this._styles._id), delete this._styles),
                    this
                  );
                }),
                (t.prototype._updateStyles = function (t, e) {
                  ...
                  var i = this.opts.cellHeight,
                    ...
                    n = '.' + this.opts._styleSheetClass + ' > .' + this.opts.itemClass;
                  if (!this._styles) {
                    var r = 'gridstack-style-' + (1e5 * Math.random()).toFixed(),
                      s = this.opts.styleInHead ? void 0 : this.el.parentNode;
                    if (((this._styles = l.Utils.createStylesheet(r, s)), !this._styles))
                      return this;
                    ((this._styles._id = r),
                      (this._styles._max = 0),
                      l.Utils.addCSSRule(this._styles, n, 'min-height: ' + i + o));
                    var a = this.opts.marginTop + this.opts.marginUnit,
                      d = this.opts.marginBottom + this.opts.marginUnit,
                      h = this.opts.marginRight + this.opts.marginUnit,
                      p = this.opts.marginLeft + this.opts.marginUnit,
                    ...
                    (l.Utils.addCSSRule(
                      ...
                      l.Utils.addCSSRule(this._styles, n + ' > .ui-resizable-ne', 'right: ' + h),
                      l.Utils.addCSSRule(this._styles, n + ' > .ui-resizable-e', 'right: ' + h),
                      l.Utils.addCSSRule(
                        this._styles,
                        n + ' > .ui-resizable-se',
                        'right: ' + h + '; bottom: ' + d,
                      ),
                      l.Utils.addCSSRule(this._styles, n + ' > .ui-resizable-nw', 'left: ' + p),
                      l.Utils.addCSSRule(this._styles, n + ' > .ui-resizable-w', 'left: ' + p),
                      l.Utils.addCSSRule(
                        this._styles,
                        n + ' > .ui-resizable-sw',
                        'left: ' + p + '; bottom: ' + d,
                  ...
                  if ((e = e || this._styles._max) > this._styles._max) {
                    for (
                      ...
                      (l.Utils.addCSSRule(
                        ...
                        l.Utils.addCSSRule(this._styles, n + '[gs-h="' + f + '"]', 'height: ' + m),
                        l.Utils.addCSSRule(
                          this._styles,
                          n + '[gs-min-h="' + f + '"]',
                          'min-height: ' + m,
                ...
                (t.prototype._updateContainerHeight = function () {
                  ...
                  var o = this.opts.cellHeight,
                    n = this.opts.cellHeightUnit;
                  return o ? ((this.el.style.height = t * o + n), this) : this;
                }),
                ...
                (t.prototype._dragOrResize = function (t, e, i, o, n, r) {}),
          ...
          var r = i(805),
            ...
            a = (function (t) {
              function e(e, i) {
                ...
                ((o.dragging = !1),
                  (o.ui = function () {
                    var t = o.el.parentElement.getBoundingClientRect(),
                      e = o.helper.getBoundingClientRect();
                ...
                return (
                  (o.dragEl = e.classList.contains(n) ? e : e.querySelector(i.handle) || e),
                  (o._dragStart = o._dragStart.bind(o)),
                  (o._drag = o._drag.bind(o)),
                  (o._dragEnd = o._dragEnd.bind(o)),
                  o.enable(),
                  o
                );
              }
              return (
                ...
                (e.prototype._dragStart = function (t) {
                  var e = this;
                  ((r.DDManager.dragElement = this),
                    (this.helper = this._createHelper(t)),
                    this._setupHelperContainmentStyle(),
                    (this.dragOffset = this._getDragOffset(t, this.el, this.helperContainment)));
                  var i = s.DDUtils.initEvent(t, { target: this.el, type: 'dragstart' });
                  (this.helper !== this.el
                    ? (this._setupDragFollowNodeNotifyStart(i), this._dragFollow(t))
                    : (this.dragFollowTimer = window.setTimeout(function () {
                        (delete e.dragFollowTimer, e._setupDragFollowNodeNotifyStart(i));
                      }, 0)),
                    this._cancelDragGhost(t));
                }),
                (e.prototype._setupDragFollowNodeNotifyStart = function (t) {
                  return (
                    this._setupHelperStyle(),
                    document.addEventListener('dragover', this._drag, e.dragEventListenerOption),
                ...
                (e.prototype._drag = function (t) {
                  ...
                  var e = s.DDUtils.initEvent(t, { target: this.el, type: 'drag' });
                ...
                (e.prototype._dragEnd = function (t) {
                  if (this.dragFollowTimer)
                    return (clearTimeout(this.dragFollowTimer), void delete this.dragFollowTimer);
                  (this.paintTimer && cancelAnimationFrame(this.paintTimer),
                    document.removeEventListener('dragover', this._drag, e.dragEventListenerOption),
                  ...
                  var i = s.DDUtils.initEvent(t, { target: this.el, type: 'dragstop' });
                  (this.option.stop && this.option.stop(i),
                    this.triggerEvent('dragstop', i),
                    delete r.DDManager.dragElement,
                    delete this.helper);
                }),
                (e.prototype._createHelper = function (t) {
                  ...
                  return (
                    'function' == typeof this.option.helper
                      ? (o = this.option.helper(t))
                      : 'clone' === this.option.helper && (o = s.DDUtils.clone(this.el)),
                ...
                (e.prototype._setupHelperStyle = function () {
                  var t = this;
                  return (
                    ...
                    (this.helper.style.position = this.option.basePosition || e.basePosition),
                    (this.helper.style.zIndex = '1000'),
                    setTimeout(function () {
                      t.helper && (t.helper.style.transition = null);
                    }, 0),
                    this
                  );
                }),
                (e.prototype._removeHelperStyle = function () {
                  var t = this,
                    i = this.helper ? this.helper.gridstackNode : void 0;
                  return (
                    (i && i._isAboutToRemove) ||
                      e.originStyleProp.forEach(function (e) {
                        t.helper.style[e] = t.dragElementOriginStyle[e] || null;
                      }),
                ...
                (e.prototype._dragFollow = function (t) {
                  ...
                  (this.paintTimer && cancelAnimationFrame(this.paintTimer),
                    (this.paintTimer = requestAnimationFrame(function () {
                      ...
                      var i = e.dragOffset,
                        o = { left: 0, top: 0 };
                      if ('absolute' === e.helper.style.position) {
                        var n = e.helperContainment.getBoundingClientRect();
                        o = { left: n.left, top: n.top };
                      }
                      ((e.helper.style.left = t.clientX + i.offsetLeft - o.left + 'px'),
                        (e.helper.style.top = t.clientY + i.offsetTop - o.top + 'px'));
                    })));
                }),
                (e.prototype._setupHelperContainmentStyle = function () {
                  return (
                    ...
                    'fixed' !== this.option.basePosition &&
                      ...
                      window.getComputedStyle(this.helperContainment).position.match(/static/) &&
                        (this.helperContainment.style.position = 'relative')),
                    this
                  );
                }),
                (e.prototype._cancelDragGhost = function (t) {
                ...
                (e.basePosition = 'absolute'),
                (e.dragEventListenerOption = !0),
                (e.originStyleProp = [
                  'transition',
                  'pointerEvents',
                  'position',
            ...
            d = (function (t) {
              function e(e, i) {
                ...
                return (
                  (o.el = e),
                  (o.option = i),
                  (o._dragEnter = o._dragEnter.bind(o)),
                  (o._dragOver = o._dragOver.bind(o)),
                  (o._dragLeave = o._dragLeave.bind(o)),
                  (o._drop = o._drop.bind(o)),
                  o.el.classList.add('ui-droppable'),
                  o.el.addEventListener('dragenter', o._dragEnter),
                  o._setupAccept(),
                  o
                );
              }
              return (
                ...
                (e.prototype._dragEnter = function (t) {
                  if (this._canDrop() && (t.preventDefault(), !this.moving)) {
                    this.moving = !0;
                    var e = l.DDUtils.initEvent(t, { target: this.el, type: 'dropover' });
                ...
                (e.prototype._dragOver = function (t) {
                  (t.preventDefault(), t.stopPropagation());
                }),
                (e.prototype._dragLeave = function (t) {
                  if (t.relatedTarget) {
                    ...
                    var e = this.el.getBoundingClientRect(),
                      ...
                      n = e.right,
                      r = e.top;
                    if (t.x < n && t.x > o && t.y < i && t.y > r) return;
                  }
                  if ((this._removeLeaveCallbacks(), this.moving)) {
                    t.preventDefault();
                    var a = l.DDUtils.initEvent(t, { target: this.el, type: 'dropout' });
                    (this.option.out && this.option.out(a, this._ui(s.DDManager.dragElement)),
                      this.triggerEvent('dropout', a));
                  }
                  delete this.moving;
                }),
                (e.prototype._drop = function (t) {
                  if (this.moving) {
                    t.preventDefault();
                    var e = l.DDUtils.initEvent(t, { target: this.el, type: 'drop' });
                ...
                (e.prototype._removeLeaveCallbacks = function () {
                ...
                (e.prototype._canDrop = function () {
                  return (
                    s.DDManager.dragElement &&
                    (!this.accept || this.accept(s.DDManager.dragElement.el))
                  );
                }),
                (e.prototype._setupAccept = function () {
                  var t = this;
                  return (
                    this.option.accept && 'string' == typeof this.option.accept
                  ...
                  return (
                    this.ddDraggable && ['drag', 'dragstart', 'dragstop'].indexOf(t) > -1
                      ...
                      : this.ddDroppable && ['drop', 'dropover', 'dropout'].indexOf(t) > -1
                        ...
                        : this.ddResizable &&
                          ['resizestart', 'resize', 'resizestop'].indexOf(t) > -1 &&
                ...
                (t.prototype.setupDraggable = function (t) {
                  return (
                    this.ddDraggable
                      ...
                      : (this.ddDraggable = new n.DDDraggable(this.el, t)),
                    this
                  );
                }),
                (t.prototype.cleanDraggable = function () {
                  return (
                    this.ddDraggable && (this.ddDraggable.destroy(), delete this.ddDraggable),
                    this
                  );
                }),
                (t.prototype.setupResizable = function (t) {
                  return (
                    this.ddResizable
                      ...
                      : (this.ddResizable = new o.DDResizable(this.el, t)),
                    this
                  );
                }),
                (t.prototype.cleanResizable = function () {
                  return (
                    this.ddResizable && (this.ddResizable.destroy(), delete this.ddResizable),
                    this
                  );
                }),
                (t.prototype.setupDroppable = function (t) {
                  return (
                    this.ddDroppable
                      ...
                      : (this.ddDroppable = new r.DDDroppable(this.el, t)),
                    this
                  );
                }),
                (t.prototype.cleanDroppable = function () {
                  return (
                    this.ddDroppable && (this.ddDroppable.destroy(), delete this.ddDroppable),
                    this
                  );
                }),
                t
            ...
            return (
              (t.prototype._init = function () {
                ...
                return (
                  ...
                  e.classList.add('' + t.prefix + this.dir),
                  (e.style.zIndex = '100'),
              ...
              (t.prototype._mouseMove = function (t) {
                ...
                !this.moving && Math.abs(t.x - e.x) + Math.abs(t.y - e.y) > 2
                  ? ((this.moving = !0), this._triggerEvent('start', this.mouseDownEvent))
          ...
          var r = i(789),
            ...
            d = (function (t) {
              function e(e, i) {
                ...
                var o = t.call(this) || this;
                return (
                  (o._showHandlers = function () {
                    o.el.classList.remove('ui-resizable-autohide');
                  }),
                  (o._hideHandlers = function () {
                    o.el.classList.add('ui-resizable-autohide');
                  }),
                  (o._ui = function () {
                    var t = o.el.parentElement.getBoundingClientRect(),
                      e = {
              ...
              return (
                ...
                (e.prototype.updateOption = function (t) {
                  ...
                  return (
                    ...
                    i && (this._removeHandlers(), this._setupHandlers()),
                    o && this._setupAutoHide(),
                    this
                  );
                }),
                (e.prototype._setupAutoHide = function () {
                  return (
                    this.option.autoHide
                ...
                (e.prototype._resizeStart = function (t) {
                  ((this.originalRect = this.el.getBoundingClientRect()),
                    (this.scrollEl = l.Utils.getScrollElement(this.el)),
                    (this.scrollY = this.scrollEl.scrollTop),
                    (this.scrolled = 0),
                    (this.startEvent = t),
                    this._setupHelper(),
                    this._applyChange());
                  var e = a.DDUtils.initEvent(t, { type: 'resizestart', target: this.el });
                  return (
                    this.option.start && this.option.start(e, this._ui()),
                ...
                (e.prototype._resizing = function (t, e) {
                  ((this.scrolled = this.scrollEl.scrollTop - this.scrollY),
                    ...
                    this._applyChange());
                  var i = a.DDUtils.initEvent(t, { type: 'resize', target: this.el });
                  return (
                ...
                (e.prototype._resizeStop = function (t) {
                  var e = a.DDUtils.initEvent(t, { type: 'resizestop', target: this.el });
                  return (
                ...
                (e.prototype._setupHelper = function () {
                  ...
                  return (
                    ...
                    window.getComputedStyle(this.el.parentElement).position.match(/static/) &&
                ...
                (e.prototype._cleanHelper = function () {
                  var t = this;
                  return (
                    e._originStyleProp.forEach(function (e, i) {
                ...
                (e.prototype._getChange = function (t, e) {
                  ...
                  (e.indexOf('e') > -1
                    ? (o.width += n)
                    : e.indexOf('w') > -1 && ((o.width -= n), (o.left += n)),
                    e.indexOf('s') > -1
                      ? (o.height += r)
                      : e.indexOf('n') > -1 && ((o.height -= r), (o.top += r)));
                  var s = this._constrainSize(o.width, o.height);
                  return (
                    Math.round(o.width) !== Math.round(s.width) &&
                      (e.indexOf('w') > -1 && (o.left += o.width - s.width), (o.width = s.width)),
                    Math.round(o.height) !== Math.round(s.height) &&
                      (e.indexOf('n') > -1 && (o.top += o.height - s.height),
                      (o.height = s.height)),
                    o
                  );
                }),
                (e.prototype._constrainSize = function (t, e) {
                  ...
                  return {
                    ...
                    height: Math.min(n, Math.max(r, e)),
                  };
                }),
                (e.prototype._applyChange = function () {
                  ...
                  if ('absolute' === this.el.style.position) {
                    var i = this.el.parentElement.getBoundingClientRect(),
                      o = i.left,
                      n = i.top;
                    e = { left: o, top: n, width: 0, height: 0 };
                  }
                  return this.temporalRect
                    ? (Object.keys(this.temporalRect).forEach(function (i) {
        ...
        234: function (t, e) {
          ...
          var o = (function () {
            ...
            return (
              ...
              (t.setPositionRelative = function (t) {
                /^(?:r|a|f)/.test(window.getComputedStyle(t).position) ||
              ...
              (t.initEvent = function (t, e) {
                ...
                return (
                  t.dataTransfer && (o.dataTransfer = t.dataTransfer),
              ...
              (t.isEventSupportPassiveOption =
                ((e = !1),
                (o = function () {}),
                document.addEventListener('test', o, {
                  get passive() {
                    return ((e = !0), !0);
                  },
                }),
                document.removeEventListener('test', o),
                e)),
              t
            );
          })();
        ...
        484: function (t, e, i) {
          var o,
            ...
            a =
              (this && this.__exportStar) ||
              function (t, e) {
                for (var i in t) 'default' === i || e.hasOwnProperty(i) || s(e, t, i);
              };
          (Object.defineProperty(e, '__esModule', { value: !0 }), (e.GridStackDDNative = void 0));
          var l = i(805),
            d = i(733),
            h = i(852),
            p = i(867);
          ...
          var u = (function (t) {
            ...
            return (
              n(e, t),
              (e.prototype.resizable = function (t, e, i, o) {
                return (
                  this._getDDElements(t).forEach(function (t) {
                    ...
                    else if ('option' === e) t.setupResizable((((n = {})[i] = o), n));
                    else {
                      var s = t.el.gridstackNode.grid,
                        a = t.el.getAttribute('gs-resize-handles')
                          ? t.el.getAttribute('gs-resize-handles')
                          : s.opts.resizable.handles;
                      t.setupResizable(
                        r(r(r({}, s.opts.resizable), { handles: a }), {
                          start: e.start,
                          stop: e.stop,
                          resize: e.resize,
                        }),
              ...
              (e.prototype.draggable = function (t, e, i, o) {
                return (
                  this._getDDElements(t).forEach(function (t) {
                    var n;
                    if ('disable' === e || 'enable' === e) t.ddDraggable && t.ddDraggable[e]();
                    else if ('destroy' === e) t.ddDraggable && t.cleanDraggable();
                    else if ('option' === e) t.setupDraggable((((n = {})[i] = o), n));
                    else {
                      var s = t.el.gridstackNode.grid;
                      t.setupDraggable(
                        r(r({}, s.opts.draggable), {
                          containment:
                            s.opts._isNested && !s.opts.dragOut
                              ? s.el.parentElement
                              : s.opts.draggable.containment || null,
                          start: e.start,
                          stop: e.stop,
                          drag: e.drag,
                        }),
              ...
              (e.prototype.droppable = function (t, e, i, o) {
                return (
              ...
              (e.prototype.isDroppable = function (t) {
                return !(
                  !(t && t.ddElement && t.ddElement.ddDroppable) || t.ddElement.ddDroppable.disabled
                );
              }),
              (e.prototype.isDraggable = function (t) {
                return !(
                  !(t && t.ddElement && t.ddElement.ddDraggable) || t.ddElement.ddDraggable.disabled
                );
              }),
              (e.prototype.isResizable = function (t) {
                return !(
                  !(t && t.ddElement && t.ddElement.ddResizable) || t.ddElement.ddResizable.disabled
                );
              }),
                ...
                return (
                  this._getDDElements(t).forEach(function (t) {
                    return t.on(e, function (t) {
                      i(
                        t,
                        l.DDManager.dragElement ? l.DDManager.dragElement.el : t.target,
                        l.DDManager.dragElement ? l.DDManager.dragElement.helper : null,
                      );
                    });
                  }),
                  this
              ...
              (e.prototype._getDDElements = function (t, e) {
                void 0 === e && (e = !0);
                var i = p.Utils.getElements(t);
                if (!i.length) return [];
                var o = i.map(function (t) {
                  return t.ddElement || (e ? d.DDElement.init(t) : null);
                });
                return (
                  e ||
                    o.filter(function (t) {
          ...
          ((e.GridStackDDNative = u), h.GridStackDD.registerPlugin(u));
        },
        855: function (t, e) {
          Object.defineProperty(e, '__esModule', { value: !0 });
        },
        867: function (t, e) {
          ...
          (Object.defineProperty(e, '__esModule', { value: !0 }),
            ...
            (e.obsoleteOptsDel = function (t, e, i, o) {
              void 0 !== t[e] &&
                console.warn('gridstack.js: Option `' + e + '` is deprecated in ' + i + o);
            }),
            ...
            return (
                ...
                if (o.top < 0 || o.bottom > n) {
                  ...
                  if (null !== a) {
                    ...
                    (o.top < 0 && i < 0
                      ? t.offsetHeight > n
                        ? (a.scrollTop += i)
                        : (a.scrollTop += Math.abs(s) > Math.abs(i) ? i : s)
                      : i > 0 &&
                        (t.offsetHeight > n ? (a.scrollTop += i) : (a.scrollTop += r > i ? i : r)),
                      (e.top += a.scrollTop - l));
                  }
                }
              }),
              (t.updateScrollResize = function (t, e, i) {
                var o = this.getScrollElement(e),
                  ...
                  a = s > n - i;
                s < i
                  ? o.scrollBy({ behavior: 'smooth', top: s - i })
                  : a && o.scrollBy({ behavior: 'smooth', top: i - (n - s) });
              }),
              (t.clone = function (t) {
          ...
          e.Utils = n;
          var r = ['_isNested', 'el', 'grid', 'subGrid', 'engine'];
        },
      },
      e = {},
      i = (function i(o) {
