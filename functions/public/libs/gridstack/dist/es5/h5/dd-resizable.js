...
var DDResizable = /** @class */ (function (_super) {
  ...
  DDResizable.prototype._setupHandlers = function () {
    ...
    this.handlers = handlerDirection
      .split(',')
      .map(function (dir) {
        return dir.trim();
      })
      .map(function (dir) {
        return new dd_resizable_handle_1.DDResizableHandle(_this.el, dir, {
  ...
  DDResizable.prototype._applyChange = function () {
    ...
    if (this.el.style.position === 'absolute') {
      ...
      var _a = containmentEl.getBoundingClientRect(),
        left = _a.left,
        top_1 = _a.top;
