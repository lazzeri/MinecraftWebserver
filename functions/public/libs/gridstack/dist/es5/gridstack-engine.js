...
var GridStackEngine = /** @class */ (function () {
  ...
  GridStackEngine.prototype._fixCollisions = function (node, nn, collide, opt) {
    ...
    while ((collide = collide || this.collide(node, area, opt.skip))) {
      ...
      if (
        ...
        moved = this.moveNode(
          node,
          __assign(__assign(__assign({}, nn), { y: collide.y + collide.h }), newOpt),
        );
        ...
        moved = this.moveNode(
          collide,
          __assign(__assign(__assign({}, collide), { y: nn.y + nn.h, skip: node }), newOpt),
        );
      }
      if (!moved) {
        return didMove;
  ...
  GridStackEngine.prototype.swap = function (a, b) {
    ...
    if (
      ...
      a.h === b.h &&
      (a.x === b.x || a.y === b.y) &&
      (touching = utils_1.Utils.isTouching(a, b))
    )
      return _doSwap();
  ...
  GridStackEngine.prototype.addNode = function (node, triggerAddEvent) {
    ...
    var dup = this.nodes.find(function (n) {
  ...
  GridStackEngine.prototype.moveNodeCheck = function (node, o) {
    ...
    clone.nodes
      ...
      .forEach(function (c) {
        var n = _this.nodes.find(function (a) {
          return a._id === c._id;
        });
        if (!n) return;
  ...
  GridStackEngine.prototype.moveNode = function (node, o) {
    ...
    if (collides.length) {
      ...
      var collide =
        node._moving && !o.nested ? this.collideCoverage(node, o, collides) : collides[0];
      if (collide) {
  ...
  GridStackEngine.prototype.save = function (saveElement) {
    ...
    this.nodes.forEach(function (n) {
      ...
      // delete internals
      for (var key in w) {
        if (key[0] === '_' || w[key] === null || w[key] === undefined) delete w[key];
      }
      delete w.grid;
  ...
  GridStackEngine.prototype.layoutsNodesChange = function (nodes) {
    ...
    this._layouts.forEach(function (layout, column) {
      if (!layout || column === _this.column) return _this;
  ...
  GridStackEngine.prototype.updateNodeWidths = function (prevColumn, column, nodes, layout) {
    ...
    if (column > prevColumn) {
      ...
      if (
        ...
        ((_a = this._layouts[lastIndex]) === null || _a === void 0 ? void 0 : _a.length)
      ) {
        prevColumn = lastIndex;
    ...
    if (nodes.length) {
      if (typeof layout === 'function') {
        ...
        nodes.forEach(function (node) {
          ...
          node.x =
            column === 1 ? 0 : move_1 ? Math.round(node.x * ratio_2) : Math.min(node.x, column - 1);
          node.w =
            column === 1 || prevColumn === 1
              ? 1
              : scale_1
                ? Math.round(node.w * ratio_2) || 1
