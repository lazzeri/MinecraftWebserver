!(function (e, t) {
  ...
  function p(e) {
    var t = !!e && 'length' in e && e.length,
      n = h(e);
    return (
      !x(e) && !g(e) && ('array' === n || 0 === t || ('number' == typeof t && 0 < t && t - 1 in e))
    );
  }
  ((E.fn = E.prototype =
    {
    ...
    E.extend({
      ...
      makeArray: function (e, t) {
        t = t || [];
        return (
          null != e && (p(Object(e)) ? E.merge(t, 'string' == typeof e ? [e] : e) : u.call(t, e)),
          t
        );
      },
  ...
  var d = (function (n) {
      ...
      if (!r && (T(e), (e = e || C), E)) {
        if (11 !== f && (s = te.exec(t)))
          if ((l = s[1])) {
            ...
            } else if (c && (o = c.getElementById(l)) && y(e, o) && o.id === l)
              return (n.push(o), n);
          } else {
            if (s[2]) return (P.apply(n, e.getElementsByTagName(t)), n);
            if ((l = s[3]) && p.getElementsByClassName && e.getElementsByClassName)
        ...
        if (
          ...
          if (((l = t), (c = e), 1 === f && (V.test(t) || X.test(t)))) {
            for (
              ((c = (ne.test(t) && ge(e.parentNode)) || e) === e && p.scope) ||
                ((a = e.getAttribute('id'))
                  ? (a = a.replace(ie, oe))
    ...
    (se.matchesSelector = function (e, t) {
      if ((T(e), p.matchesSelector && E && !j[t + ' '] && (!s || !s.test(t)) && (!v || !v.test(t))))
        try {
          var n = c.call(e, t);
        ...
        : function (e, t, n) {
            ...
            if (n) {
              ...
              for (; (e = e[s]); )
                if (1 === e.nodeType || c)
                  if (
                    ((r = (i = e[S] || (e[S] = {}))[e.uniqueID] || (i[e.uniqueID] = {})),
      ...
      return (
        ...
        le(function (e, t, n, r) {
          ...
          if (e) {
            ...
            ((p = be(p === t ? p.splice(l, p.length) : p)), y ? y(null, t, p, r) : P.apply(t, p));
        })
      );
    }
    function Te(v, y) {
        ...
        function (e, t, n, r) {
          ...
          if (((n = n || []), 1 === c.length)) {
            ...
            for (
              ...
              if (
                (u = b.find[s]) &&
                (r = u(a.matches[0].replace(re, f), (ne.test(o[0].type) && ge(t.parentNode)) || t))
              ) {
  ...
  ((E.fn.ready = function (e) {
    ...
    'complete' === C.readyState || ('loading' !== C.readyState && !C.documentElement.doScroll)
      ...
      : (C.addEventListener('DOMContentLoaded', B), T.addEventListener('load', B)));
  ...
  ((de.tbody = de.tfoot = de.colgroup = de.caption = de.thead),
    (de.th = de.td),
    m.option || (de.optgroup = de.option = [1, "<select multiple='multiple'>", '</select>']));
  var ve = /<|&#?\w+;/;
        ...
        for (
          ...
          for (
            ...
            (s.rnamespace && !1 !== i.namespace && !s.rnamespace.test(i.namespace)) ||
              ...
              (s.data = i.data),
              void 0 !==
                (i = ((E.event.special[i.origType] || {}).handle || i.handler).apply(r.elem, a)) &&
                !1 === (s.result = i) &&
  ...
  function He(n, r, i, o) {
    ...
    if (
      ...
      for (s = (a = E.map(he(e, 'script'), je)).length; c < f; c++)
        ((u = e),
          c !== p && ((u = E.clone(u, !0, !0)), s && E.merge(a, he(u, 'script'))),
          i.call(n[c], u, c));
      if (s)
  ...
  function Oe(e, t, n) {
    for (var r, i = t ? E.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      (n || 1 !== r.nodeType || E.cleanData(he(r)),
        r.parentNode && (n && ie(r) && ge(he(r, 'script')), r.parentNode.removeChild(r)));
    return e;
  }
  (E.extend({
    ...
    css: function (e, t, n, r) {
      ...
      return (
        ...
        'normal' ===
          (i =
            void 0 ===
            (i = (o = E.cssHooks[t] || E.cssHooks[o]) && 'get' in o ? o.get(e, !0, n) : i)
              ? Ye(e, t, r)
              : i) &&
          t in it &&
          (i = it[t]),
  ...
  function yt(i, e, t) {
    var n,
      ...
      u = function () {
        ...
        return (
          ...
          t < 1 && r ? e : (r || s.notifyWith(i, [l, 1, 0]), s.resolveWith(i, [l]), !1)
        );
      },
      l = s.promise({
        elem: i,
        ...
        stop: function (e) {
          ...
          return (
            e ? (s.notifyWith(i, [l, 1, 0]), s.resolveWith(i, [l, e])) : s.rejectWith(i, [l, e]),
            this
          );
        },
      }),
    ...
    for (
      ...
      if ((n = yt.prefilters[r].call(l, i, c, l.opts)))
        return (x(n.stop) && (E._queueHooks(l.elem, l.opts.queue).stop = n.stop.bind(n)), n);
    return (
      E.map(c, vt, l),
      ...
      attr: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return void 0 === e.getAttribute
            ? E.prop(e, t, n)
            : ((1 === o && E.isXMLDoc(e)) ||
                (i = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? mt : void 0)),
              void 0 !== n
                ? null === n
  ...
  (E.extend(E.event, {
    trigger: function (e, t, n, r) {
      ...
      if (
        ...
        if (!r && !l.noBubble && !g(n)) {
          for (a = l.delegateType || p, At.test(a + p) || (h = h.parentNode); h; h = h.parentNode)
            (f.push(h), (o = h));
        ...
        for (i = 0; (h = f[i++]) && !e.isPropagationStopped(); )
          ((c = h),
            ...
            (u = (Y.get(h, 'events') || Object.create(null))[e.type] && Y.get(h, 'handle')) &&
              u.apply(h, t),
            (u = s && h[s]) &&
              u.apply &&
              V(h) &&
      ...
      ajax: function (e, t) {
        ...
        var u,
          ...
          b = {
            ...
            setRequestHeader: function (e, t) {
              return (
                null == p && ((e = a[e.toLowerCase()] = a[e.toLowerCase()] || e), (o[e] = t)),
                this
              );
            },
        ...
        if (
          ...
          try {
            ((i.href = h.url),
              (i.href = i.href),
              (h.crossDomain = zt.protocol + '//' + zt.host != i.protocol + '//' + i.host));
          } catch (e) {
            h.crossDomain = !0;
          }
        }
        ...
        h.hasContent
          ...
          : ((i = h.url.slice(l.length)),
            ...
            !1 === h.cache &&
              ((l = l.replace(Mt, '$1')), (i = (jt.test(l) ? '&' : '?') + '_=' + Dt.guid++ + i)),
            (h.url = l + i)),
        h.ifModified &&
          (E.lastModified[l] && b.setRequestHeader('If-Modified-Since', E.lastModified[l]),
        ...
        b.setRequestHeader(
          ...
          h.dataTypes[0] && h.accepts[h.dataTypes[0]]
            ? h.accepts[h.dataTypes[0]] + ('*' !== h.dataTypes[0] ? ', ' + _t + '; q=0.01' : '')
            : h.accepts['*'],
        ),
        h.headers))
        ...
        function w(e, t, n, r) {
          ...
          p ||
            ...
            r
              ? (h.ifModified &&
                  ((n = b.getResponseHeader('Last-Modified')) && (E.lastModified[l] = n),
            ...
            m.fireWith(g, [b, s]),
            d && (v.trigger('ajaxComplete', [b, h]), --E.active || E.event.trigger('ajaxStop')));
        }
        return b;
      },
      ...
      if (a || 'jsonp' === e.dataTypes[0])
        return (
          ...
          a
            ...
            : !1 !== e.jsonp && (e.url += (jt.test(e.url) ? '&' : '?') + e.jsonp + '=' + r),
    ...
    (E.parseHTML = function (e, t, n) {
      return 'string' != typeof e
        ...
        : ('boolean' == typeof t && ((n = t), (t = !1)),
          ...
          (n = N.exec(e))
            ? [t.createElement(n[1])]
            : ((n = ye([e], t, r)), r && r.length && E(r).remove(), E.merge([], n.childNodes)));
      var r;
    }),
