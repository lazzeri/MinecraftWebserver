    ...
    (e = {
      21: (e, t, i) => {
        ...
        class r extends n.GridStackDDI {
          ...
          remove(e) {
            return (
              this.draggable(e, 'destroy').resizable(e, 'destroy'),
        ...
        ((t.GridStackDD = r),
          (s.GridStack.prototype._setupAcceptWidget = function () {
            if (this.opts.staticGrid || (!this.opts.acceptWidgets && !this.opts.removable))
              return (r.get().droppable(this.el, 'destroy'), this);
            let e,
              t,
              i,
              n = (n, s, a) => {
                ...
                let h = (a = a || s).getBoundingClientRect(),
                  c = h.left - e.left,
                  u = h.top - e.top,
                  d = { position: { top: u, left: c } };
                if (l._temporaryRemoved) {
                  if (
                    ((l.x = Math.max(0, Math.round(c / i))),
                    (l.y = Math.max(0, Math.round(u / t))),
                    delete l.autoPosition,
                    this.engine.nodeBoundFix(l),
                    !this.engine.willItFit(l))
                  ) {
                    if (((l.autoPosition = !0), !this.engine.willItFit(l)))
                      return void r.get().off(s, 'drag');
            ...
            return (
              r
                ...
                .on(this.el, 'dropover', (s, o, l) => {
                  let h = o.gridstackNode;
                  if ((null == h ? void 0 : h.grid) === this && !h._temporaryRemoved) return !1;
                  (null == h ? void 0 : h.grid) &&
                    h.grid !== this &&
                    !h._temporaryRemoved &&
                    h.grid._leave(o, l);
                  let c = this.el.getBoundingClientRect();
                  ((e = { top: c.top, left: c.left }),
                    (i = this.cellWidth()),
                    (t = this.getCellHeight(!0)),
                    h || (h = this._readAttr(o)),
                    h.grid || ((h._isExternal = !0), (o.gridstackNode = h)),
                    (l = l || o));
                  let u = h.w || Math.round(l.offsetWidth / i) || 1,
                    d = h.h || Math.round(l.offsetHeight / t) || 1;
                  return (
                    h.grid && h.grid !== this
                      ? (o._gridstackNodeOrig || (o._gridstackNodeOrig = h),
                        (o.gridstackNode = h =
                          Object.assign(Object.assign({}, h), { w: u, h: d, grid: this })),
                        this.engine.cleanupNode(h).nodeBoundFix(h),
                        (h._initDD = h._isExternal = h._temporaryRemoved = !0))
                      : ((h.w = u), (h.h = d), (h._temporaryRemoved = !0)),
                    a(h.el, !1),
                    r.get().on(o, 'drag', n),
                    n(s, o, l),
                    !1
                ...
                .on(this.el, 'dropout', (e, t, i) => {
                  ...
                  return !!n && ((n.grid && n.grid !== this) || this._leave(t, i), !1);
                })
                .on(this.el, 'drop', (e, t, i) => {
                  let n = t.gridstackNode;
                  if ((null == n ? void 0 : n.grid) === this && !n._isExternal) return !1;
                  ...
                  return (
                    !!n &&
                    (s && (this.engine.cleanupNode(n), (n.grid = this)),
                    r.get().off(t, 'drag'),
                    i !== t
                      ? (i.remove(), (t.gridstackNode = a), s && (t = t.cloneNode(!0)))
                      : (t.remove(), r.get().remove(t)),
                    !!s &&
                      ((t.gridstackNode = n),
                      (n.el = t),
                      o.Utils.copyPos(n, this._readAttr(this.placeholder)),
                      o.Utils.removePositioningStyles(t),
                      this._writeAttr(t, n),
                      this.el.appendChild(t),
                      this._updateContainerHeight(),
                      this.engine.addedNodes.push(n),
                      this._triggerAddEvent(),
                      this._triggerChangeEvent(),
                      this.engine.endUpdate(),
                      this._gsEventHandler.dropped &&
                        this._gsEventHandler.dropped(
                          Object.assign(Object.assign({}, e), { type: 'dropped' }),
                          a && a.grid ? a : void 0,
                          n,
                        ),
                      window.setTimeout(() => {
            ...
            if (!this.opts.staticGrid && 'string' == typeof this.opts.removable) {
              ...
              r.get().isDroppable(e) ||
                r
                  ...
                  .on(e, 'dropover', (e, t) => a(t, !0))
                  .on(e, 'dropout', (e, t) => a(t, !1));
            }
            return this;
          }),
          ...
          (s.GridStack.prototype._prepareDragDropByNode = function (e) {
            ...
            if (
              ...
              ((e.noMove || this.opts.disableDrag) && (e.noResize || this.opts.disableResize))
            )
              return (
                e._initDD && (i.remove(t), delete e._initDD),
            ...
            if (!e._initDD) {
              let n,
                ...
                r = (i, o) => {
                  (this._gsEventHandler[i.type] && this._gsEventHandler[i.type](i, i.target),
                    (n = this.cellWidth()),
                    (s = this.getCellHeight(!0)),
                    this._onStartMoving(t, i, o, e, n, s));
                },
                a = (i, o) => {
                ...
                l = (n) => {
                  ...
                  if (s.gridstackNode && s.gridstackNode.grid === this) {
                    if (((e.el = s), e._isAboutToRemove)) {
                      ...
                      (o._gsEventHandler[n.type] && o._gsEventHandler[n.type](n, s),
                        i.remove(t),
                        o.engine.removedNodes.push(e),
                        o._triggerRemoveEvent(),
                      ...
                      (e._temporaryRemoved
                        ? (o.Utils.removePositioningStyles(s),
                          o.Utils.copyPos(e, e._orig),
                          this._writePosAttr(s, e),
                          this.engine.addNode(e))
                        : (o.Utils.removePositioningStyles(s), this._writePosAttr(s, e)),
                        this._gsEventHandler[n.type] && this._gsEventHandler[n.type](n, s));
              ...
              (i
                .draggable(t, { start: r, stop: l, drag: a })
                .resizable(t, { start: r, stop: l, resize: a }),
                (e._initDD = !0));
            }
            return (
              e.noMove || this.opts.disableDrag
                ? (i.draggable(t, 'disable'), t.classList.add('ui-draggable-disabled'))
                : (i.draggable(t, 'enable'), t.classList.remove('ui-draggable-disabled')),
              e.noResize || this.opts.disableResize
                ? (i.resizable(t, 'disable'), t.classList.add('ui-resizable-disabled'))
                : (i.resizable(t, 'enable'), t.classList.remove('ui-resizable-disabled')),
              this
            );
          }),
          (s.GridStack.prototype._onStartMoving = function (e, t, i, n, s, o) {
            if (
              ...
              let t = r
                .get()
                .resizable(e, 'option', 'minWidth', s * (n.minW || 1))
                .resizable(e, 'option', 'minHeight', o * (n.minH || 1));
              (n.maxW && t.resizable(e, 'option', 'maxWidth', s * n.maxW),
                n.maxH && t.resizable(e, 'option', 'maxHeight', o * n.maxH));
            }
          }),
          ...
          (s.GridStack.prototype._dragOrResize = function (e, t, i, n, s, r) {
            ...
            if (
              ...
              let a = i.position.left + (i.position.left > n._lastUiPosition.left ? -c : h),
                p = i.position.top + (i.position.top > n._lastUiPosition.top ? -d : u);
              ((l.x = Math.round(a / s)), (l.y = Math.round(p / r)));
              let f = this._extraDragRow;
              ...
              if (
                (this._extraDragRow !== f && this._updateContainerHeight(),
                n.x === l.x && n.y === l.y)
              )
                return;
              ...
              if (l.x < 0) return;
              if (
                (o.Utils.updateScrollResize(t, e, r),
                (l.w = Math.round((i.size.width - h) / s)),
                (l.h = Math.round((i.size.height - u) / r)),
                n.w === l.w && n.h === l.h)
              )
                return;
              if (n._lastTried && n._lastTried.w === l.w && n._lastTried.h === l.h) return;
              let c = i.position.left + h,
                d = i.position.top + u;
              ((l.x = Math.round(c / s)), (l.y = Math.round(d / r)), (a = !0));
            }
            n._lastTried = l;
            let g = {
              x: i.position.left + h,
              y: i.position.top + u,
              w: (i.size ? i.size.width : n.w * s) - h - c,
              h: (i.size ? i.size.height : n.h * r) - u - d,
            };
            if (
              ...
              ((n._lastUiPosition = i.position),
                this.engine.cacheRects(s, r, u, c, d, h),
                delete n._skipDown,
          ...
          (s.GridStack.prototype.enableMove = function (e) {
            return (
              this.opts.staticGrid ||
                ((this.opts.disableDrag = !e),
                this.engine.nodes.forEach((t) => this.movable(t.el, e))),
              this
            );
          }),
          (s.GridStack.prototype.enableResize = function (e) {
            return (
              this.opts.staticGrid ||
                ((this.opts.disableResize = !e),
                this.engine.nodes.forEach((t) => this.resizable(t.el, e))),
              this
            );
          }));
      },
        ...
        class s {
          ...
          _fixCollisions(e, t = e, i, s = {}) {
            ...
            this._useEntireRowArea(e, t) &&
              ((o = { x: 0, w: this.column, y: t.y, h: t.h }), (i = this.collide(e, o, s.skip)));
            let r = !1,
              a = { nested: !0, pack: !1 };
            for (; (i = i || this.collide(e, o, s.skip)); ) {
              ...
              if (
                ...
                (e._moving &&
                  ...
                  t.y > e.y &&
                  !this.float &&
                  (!this.collide(i, Object.assign(Object.assign({}, i), { y: e.y }), e) ||
                    !this.collide(i, Object.assign(Object.assign({}, i), { y: t.y - i.h }), e)))
                  ? ((e._skipDown = e._skipDown || t.y > e.y),
                    (o = this.moveNode(
                      e,
                      Object.assign(Object.assign(Object.assign({}, t), { y: i.y + i.h }), a),
                    )),
                    i.locked && o
                      ? n.Utils.copyPos(t, e)
                      : !i.locked &&
                        o &&
                        s.pack &&
                        (this._packNodes(), (t.y = i.y + i.h), n.Utils.copyPos(e, t)),
                    (r = r || o))
                  : (o = this.moveNode(
                      i,
                      Object.assign(
                        Object.assign(Object.assign({}, i), { y: t.y + t.h, skip: e }),
                        a,
                      ),
                    )),
                !o)
            ...
            return (
              ...
              i.forEach((e) => {
                ...
                (s.y < t.y
                  ...
                  s.x < t.x
                    ? (r = (o.x + o.w - t.x) / t.w)
                    : s.x + s.w > t.x + t.w && (r = (t.x + t.w - o.x) / t.w));
                let l = Math.min(r, i);
                l > a && ((a = l), (n = e));
              }),
              n
          ...
          swap(e, t) {
            ...
            if (
              ...
              e.h === t.h &&
              (e.x === t.x || e.y === t.y) &&
              (s = n.Utils.isTouching(e, t))
            )
              return i();
            if (!1 !== s) {
              if (e.w === t.w && e.x === t.x && (s || (s = n.Utils.isTouching(e, t)))) {
                if (t.y < e.y) {
                  let i = e;
                  ((e = t), (t = i));
                }
              ...
              if (!1 !== s) {
                if (e.h === t.h && e.y === t.y && (s || (s = n.Utils.isTouching(e, t)))) {
                  if (t.x < e.x) {
                    let i = e;
                    ((e = t), (t = i));
                  }
          ...
          nodeBoundFix(e, t) {
            let i = e._orig || n.Utils.copyPos({}, e);
            return (
              ...
              n.Utils.samePos(e, i) || (e._dirty = !0),
              e
            );
          }
          getDirtyNodes(e) {
            return e
              ? this.nodes.filter((e) => e._dirty && !n.Utils.samePos(e, e._orig))
          ...
          addNode(e, t = !1) {
            ...
            if (i) return i;
            if (
              (delete (e = this._inColumnResize ? this.nodeBoundFix(e) : this.prepareNode(e))
                ._temporaryRemoved,
              delete e._removeDOM,
              e.autoPosition)
            ) {
          ...
          moveNodeCheck(e, t) {
            ...
            if (this.maxRow && r && ((r = o.getRow() <= this.maxRow), !r && !t.resizing)) {
          ...
          willItFit(e) {
            ...
            return (
              ...
              delete i.grid,
              t.addNode(i),
              t.getRow() <= this.maxRow && ((e._willFitPos = n.Utils.copyPos({}, i)), !0)
            );
          }
          ...
          moveNode(e, t) {
            ...
            return (
              l && ((e._dirty = !0), n.Utils.copyPos(e, s)),
            ...
            return (
              ...
              this.nodes.forEach((t) => {
                let i = null == n ? void 0 : n.find((e) => e._id === t._id),
                  o = Object.assign({}, t);
                i && ((o.x = i.x), (o.y = i.y), (o.w = i.w));
                for (let e in o) ('_' !== e[0] && null !== o[e] && void 0 !== o[e]) || delete o[e];
                (delete o.grid,
                  e || delete o.el,
                  o.autoPosition || delete o.autoPosition,
                  o.noResize || delete o.noResize,
                  o.noMove || delete o.noMove,
                  o.locked || delete o.locked,
                  s.push(o));
              }),
              s
            );
          ...
          updateNodeWidths(e, t, i, s = 'moveScale') {
            ...
            if (t > e) {
              ...
              !l.length &&
                e !== n &&
                (null === (o = this._layouts[n]) || void 0 === o ? void 0 : o.length) &&
                ((e = n),
            ...
            if (
              (l.forEach((e) => {
                ...
                -1 !== t &&
                  ((i[t].x = e.x), (i[t].y = e.y), (i[t].w = e.w), r.push(i[t]), i.splice(t, 1));
              }),
              i.length)
            )
              if ('function' == typeof s) s(t, e, r, i);
              else if (!a) {
                let n = t / e,
                  o = 'move' === s || 'moveScale' === s,
                  a = 'scale' === s || 'moveScale' === s;
                (i.forEach((i) => {
                  ((i.x = 1 === t ? 0 : o ? Math.round(i.x * n) : Math.min(i.x, t - 1)),
                    (i.w =
                      1 === t || 1 === e ? 1 : a ? Math.round(i.w * n) || 1 : Math.min(i.w, t)),
                    r.push(i));
                }),
                  (i = []));
              }
            return (
              (r = n.Utils.sort(r, -1, t)),
          ...
          cacheLayout(e, t, i = !1) {
            ...
            return (
              e.forEach((e, t) => {
                ((e._id = e._id || s._idSeq++), (n[t] = { x: e.x, y: e.y, w: e.w, _id: e._id }));
              }),
      ...
      270: function (e, t, i) {
        ...
        const o = i(62),
          r = i(593),
          a = i(334);
        (s(i(699), t), s(i(593), t), s(i(62), t), s(i(334), t));
        const l = {
          column: 12,
          minRow: 0,
          maxRow: 0,
        ...
        class h {
          constructor(e, t = {}) {
            ...
            let i = r.Utils.toNumber(e.getAttribute('gs-row')),
              n = Object.assign(Object.assign({}, r.Utils.cloneDeep(l)), {
                column: r.Utils.toNumber(e.getAttribute('gs-column')) || 12,
                minRow: i || r.Utils.toNumber(e.getAttribute('gs-min-row')) || 0,
                maxRow: i || r.Utils.toNumber(e.getAttribute('gs-max-row')) || 0,
                staticGrid: r.Utils.toBool(e.getAttribute('gs-static')) || !1,
            ...
            (e.getAttribute('gs-animate') &&
              (n.animate = r.Utils.toBool(e.getAttribute('gs-animate'))),
              (this.opts = r.Utils.defaults(t, n)),
              (t = null),
              this.initMargin(),
              1 !== this.opts.column &&
            ...
            let s = r.Utils.closestByClass(this.el, l.itemClass);
            if (
              (s &&
                s.gridstackNode &&
                ((this.opts._isNested = s.gridstackNode),
              ...
              this._isAutoCellHeight || 'initial' === this.opts.cellHeight
                ...
                : ('number' == typeof this.opts.cellHeight &&
                    ...
                    this.opts.cellHeightUnit !== l.cellHeightUnit &&
          ...
          static init(e = {}, t = '.grid-stack') {
            ...
            return i
              ? (i.gridstack || (i.gridstack = new h(i, r.Utils.cloneDeep(e))), i.gridstack)
              : ('string' == typeof t
                  ? console.error(
          ...
          static initAll(e = {}, t = '.grid-stack') {
            let i = [];
            return (
              h.getGridElements(t).forEach((t) => {
                (t.gridstack ||
                  ((t.gridstack = new h(t, r.Utils.cloneDeep(e))),
                  delete e.dragIn,
          ...
          static addGrid(e, t = {}) {
            ...
            if (!e.classList.contains('grid-stack')) {
              ...
              ((n.body.innerHTML = `<div class="grid-stack ${t.class || ''}"></div>`),
                (i = n.body.children[0]),
                e.appendChild(i));
            }
            let n = h.init(t, i);
          ...
          addWidget(e, t) {
            ...
            if ('string' == typeof e) {
              ...
              ((s.body.innerHTML = `<div class="grid-stack-item ${this.opts.itemClass || ''}"><div class="grid-stack-item-content">${n}</div></div>`),
                (i = s.body.children[0]));
            } else i = e;
            var n;
            let s = this._readAttr(i);
            ((t = r.Utils.cloneDeep(t) || {}), r.Utils.defaults(t, s));
            let o = this.engine.prepareNode(t);
            if (
              (this._writeAttr(i, t),
              this._insertNotAppend ? this.el.prepend(i) : this.el.appendChild(i),
              this._prepareElement(i, !0, t),
              this._updateContainerHeight(),
              o.subGrid && !o.subGrid.el)
            ) {
              let e = o.el.querySelector('.grid-stack-item-content');
              o.subGrid = h.addGrid(e, o.subGrid);
            }
          ...
          save(e = !0, t = !1) {
            ...
            if (
              ...
              return (
                ...
                r.Utils.removeInternalAndSame(e, l),
                (e.children = i),
                e
              );
            }
          ...
          load(e, t = !0) {
            let i = h.Utils.sort([...e], -1, this._prevColumn || this.opts.column);
              ...
              i.forEach((e) => {
                ...
                if (i) {
                  if ((this.update(i.el, e), e.subGrid && e.subGrid.children)) {
                    ...
                    t &&
                      t.gridstack &&
                      (t.gridstack.load(e.subGrid.children), (this._insertNotAppend = !0));
                  }
                } else
                  t &&
                    (e =
          ...
          cellHeight(e, t = !0) {
            if (
              (t &&
                ...
                ((this._isAutoCellHeight = 'auto' === e), this._updateWindowResizeEvent()),
            ...
            if (this.el)
              return (
                ...
                e
                  ...
                  : (this.removeAll(e), this.el.classList.remove(this.opts._styleSheetClass)),
          ...
          removeAll(e = !0) {
            return (
              this.engine.nodes.forEach((e) => {
                (delete e.el.gridstackNode, a.GridStackDDI.get().remove(e.el));
              }),
          ...
          update(e, t) {
            if (arguments.length > 2) {
              ...
              let i = arguments,
                n = 1;
              return ((t = { x: i[n++], y: i[n++], w: i[n++], h: i[n++] }), this.update(e, t));
            }
            return (
              h.getElements(e).forEach((e) => {
                if (!e || !e.gridstackNode) return;
                let i = e.gridstackNode,
                  n = r.Utils.cloneDeep(t);
                delete n.autoPosition;
                let s,
                  o = ['x', 'y', 'w', 'h'];
                if (
                  (o.some((e) => void 0 !== n[e] && n[e] !== i[e]) &&
                    ((s = {}),
                    o.forEach((e) => {
          ...
          _removeStylesheet() {
            return (
              this._styles && (r.Utils.removeStylesheet(this._styles._id), delete this._styles),
              this
            );
          }
          _updateStyles(e = !1, t) {
            ...
            if (!this._styles) {
              ...
              ((this._styles._id = e),
                (this._styles._max = 0),
                r.Utils.addCSSRule(this._styles, s, `min-height: ${i}${n}`));
              let o = this.opts.marginTop + this.opts.marginUnit,
                ...
                c = `${s} > .grid-stack-item-content`,
                u = `.${this.opts._styleSheetClass} > .grid-stack-placeholder > .placeholder-content`;
              (r.Utils.addCSSRule(
                this._styles,
                c,
                `top: ${o}; right: ${l}; bottom: ${a}; left: ${h};`,
              ),
                r.Utils.addCSSRule(
                  this._styles,
                  u,
                ...
                r.Utils.addCSSRule(this._styles, `${s} > .ui-resizable-ne`, `right: ${l}`),
                r.Utils.addCSSRule(this._styles, `${s} > .ui-resizable-e`, `right: ${l}`),
                r.Utils.addCSSRule(
                  this._styles,
                  `${s} > .ui-resizable-se`,
                  `right: ${l}; bottom: ${a}`,
                ),
                r.Utils.addCSSRule(this._styles, `${s} > .ui-resizable-nw`, `left: ${h}`),
                r.Utils.addCSSRule(this._styles, `${s} > .ui-resizable-w`, `left: ${h}`),
                r.Utils.addCSSRule(
                  this._styles,
                  `${s} > .ui-resizable-sw`,
                  `left: ${h}; bottom: ${a}`,
            ...
            if ((t = t || this._styles._max) > this._styles._max) {
              ...
              for (let i = this._styles._max + 1; i <= t; i++) {
                let t = e(i);
                (r.Utils.addCSSRule(this._styles, `${s}[gs-y="${i - 1}"]`, `top: ${e(i - 1)}`),
                  r.Utils.addCSSRule(this._styles, `${s}[gs-h="${i}"]`, `height: ${t}`),
                  r.Utils.addCSSRule(this._styles, `${s}[gs-min-h="${i}"]`, `min-height: ${t}`),
                  r.Utils.addCSSRule(this._styles, `${s}[gs-max-h="${i}"]`, `max-height: ${t}`));
              }
              this._styles._max = t;
            }
            return this;
          ...
          _prepareElement(e, t = !1, i) {
            ...
            return (
              ...
              r.Utils.same(i, n) || this._writeAttr(e, i),
          ...
          onParentResize() {
            ...
            return (
              ...
              this._isAutoCellHeight &&
                (!t && this.opts.cellHeightThrottle
                  ? (this._cellHeightThrottle ||
                      (this._cellHeightThrottle = r.Utils.throttle(
                        () => this.cellHeight(),
          ...
          _updateWindowResizeEvent(e = !1) {
            const t =
              (this._isAutoCellHeight || !this.opts.disableOneColumnMode) && !this.opts._isNested;
            return (
        ...
        ((t.GridStack = h), (h.Utils = r.Utils), (h.Engine = o.GridStackEngine));
      },
      906: function (e, t, i) {
        'use strict';
        var n =
        ...
        (Object.defineProperty(t, '__esModule', { value: !0 }),
          (t.GridStackDDJQueryUI = t.$ = void 0));
        const o = i(21),
          r = i(28);
        ((t.$ = r), i(87), i(949), s(i(21), t));
        class a extends o.GridStackDD {
          resizable(e, t, i, n) {
            let s = r(e);
            if ('enable' === t) s.resizable().resizable(t);
            else if ('disable' === t || 'destroy' === t) s.data('ui-resizable') && s.resizable(t);
            else if ('option' === t) s.resizable(t, i, n);
            else {
              const i = e.gridstackNode.grid;
              let n = s.data('gs-resize-handles')
                ? s.data('gs-resize-handles')
                : i.opts.resizable.handles;
              s.resizable(
                Object.assign(Object.assign(Object.assign({}, i.opts.resizable), { handles: n }), {
                  start: t.start,
                  stop: t.stop,
                  resize: t.resize,
                }),
          ...
          draggable(e, t, i, n) {
            let s = r(e);
            if ('enable' === t) s.draggable().draggable('enable');
            else if ('disable' === t || 'destroy' === t) s.data('ui-draggable') && s.draggable(t);
            else if ('option' === t) s.draggable(t, i, n);
            else {
              const i = e.gridstackNode.grid;
              s.draggable(
                Object.assign(Object.assign({}, i.opts.draggable), {
                  containment:
                    i.opts._isNested && !i.opts.dragOut
                      ? r(i.el).parent()
                      : i.opts.draggable.containment || null,
                  start: t.start,
                  stop: t.stop,
                  drag: t.drag,
                }),
          ...
          droppable(e, t, i, n) {
            ...
            return (
              'function' != typeof t.accept ||
                t._accept ||
                ((t._accept = t.accept), (t.accept = (e) => t._accept(e.get(0)))),
              'disable' === t || 'destroy' === t
                ? s.data('ui-droppable') && s.droppable(t)
                : s.droppable(t, i, n),
              this
            );
          }
          ...
          off(e, t) {
            return (r(e).off(t), this);
          }
        }
        ((t.GridStackDDJQueryUI = a), o.GridStackDD.registerPlugin(a));
      },
      699: (e, t) => {
        'use strict';
        Object.defineProperty(t, '__esModule', { value: !0 });
      ...
      593: (e, t) => {
        ...
        class i {
          ...
          static closestByClass(e, t) {
            for (; (e = e.parentElement); ) if (e.classList.contains(t)) return e;
            return null;
          }
          static throttle(e, t) {
            let i = !1;
            ...
            if (n.top < 0 || n.bottom > s) {
              ...
              if (null !== a) {
                ...
                (n.top < 0 && i < 0
                  ...
                  : i > 0 &&
                    (e.offsetHeight > s ? (a.scrollTop += i) : (a.scrollTop += o > i ? i : o)),
                  (t.top += a.scrollTop - l));
              }
            }
          }
          static updateScrollResize(e, t, i) {
            const n = this.getScrollElement(t),
              s = n.clientHeight,
              o = n === this.getScrollElement() ? 0 : n.getBoundingClientRect().top,
              r = e.clientY - o,
              a = r > s - i;
            r < i
              ? n.scrollBy({ behavior: 'smooth', top: r - i })
              : a && n.scrollBy({ behavior: 'smooth', top: i - (s - r) });
          }
          static clone(e) {
        ...
        t.Utils = i;
        const n = ['_isNested', 'el', 'grid', 'subGrid', 'engine'];
      },
      87: (e, t, i) => {
        var n, s, o;
        ((s = [i(28)]),
                  ...
                  (e.widget = function (t, i, n) {
                    ...
                    return (
                      ...
                      (o.prototype = e.widget.extend(
                        ...
                        a,
                        { constructor: o, namespace: l, widgetName: t, widgetFullName: h },
                      )),
                      s
                  ...
                  (e.Widget.prototype = {
                    ...
                    option: function (t, i) {
                      ...
                      if ('string' == typeof t)
                        if (((r = {}), (n = t.split('.')), (t = n.shift()), n.length)) {
                          for (
                            s = r[t] = e.widget.extend({}, this.options[t]), o = 0;
                            o < n.length - 1;
                            o++
                          )
                            ((s[n[o]] = s[n[o]] || {}), (s = s[n[o]]));
                    ...
                    _trigger: function (t, i, n) {
                      ...
                      return (
                        ...
                        !(
                          (e.isFunction(r) && !1 === r.apply(this.element[0], [i].concat(n))) ||
                ...
                (e(document).on('mouseup', function () {
                  ...
                  (e.ui.plugin = {
                    ...
                    call: function (e, t, i, n) {
                      ...
                      if (
                        o &&
                        (n || (e.element[0].parentNode && 11 !== e.element[0].parentNode.nodeType))
                      )
                          ...
                          ? 'window' !== s.containment
                            ? 'document' !== s.containment
                              ...
                              : (this.containment = [
                                  0,
                                  0,
                                  e(o).width() - this.helperProportions.width - this.margins.left,
                                  (e(o).height() || o.body.parentNode.scrollHeight) -
                                    this.helperProportions.height -
                                    this.margins.top,
                                ])
                            : (this.containment = [
                                ...
                                e(window).scrollLeft() +
                                  ...
                                  this.margins.left,
                                e(window).scrollTop() +
                                  (e(window).height() || o.body.parentNode.scrollHeight) -
                                  this.helperProportions.height -
                                  this.margins.top,
                              ])
                      ...
                      ((n.cancelHelperRemoval = !1),
                        e.each(n.sortables, function () {
                          ...
                          e.isOver
                            ...
                            : ((e.cancelHelperRemoval = !0), e._trigger('deactivate', t, s));
                        }));
                    },
                    drag: function (t, i, n) {
                      e.each(n.sortables, function () {
                        ...
                        ((o.positionAbs = n.positionAbs),
                          ...
                          s
                            ? (o.isOver ||
                                ...
                                (o.fromOutside = n)),
                              o.currentItem && (o._mouseDrag(t), (i.position = o.position)))
                            : o.isOver &&
                              ((o.isOver = 0),
                  ...
                  e.ui.plugin.add('draggable', 'scroll', {
                    ...
                    drag: function (t, i, n) {
                      ...
                      (r !== a && 'HTML' !== r.tagName
                        ? ((s.axis && 'x' === s.axis) ||
                            (n.overflowOffset.top + r.offsetHeight - t.pageY < s.scrollSensitivity
                              ? (r.scrollTop = o = r.scrollTop + s.scrollSpeed)
                              : t.pageY - n.overflowOffset.top < s.scrollSensitivity &&
                                (r.scrollTop = o = r.scrollTop - s.scrollSpeed)),
                          (s.axis && 'y' === s.axis) ||
                            (n.overflowOffset.left + r.offsetWidth - t.pageX < s.scrollSensitivity
                              ? (r.scrollLeft = o = r.scrollLeft + s.scrollSpeed)
                              : t.pageX - n.overflowOffset.left < s.scrollSensitivity &&
                                (r.scrollLeft = o = r.scrollLeft - s.scrollSpeed)))
                        : ((s.axis && 'x' === s.axis) ||
                            (t.pageY - e(a).scrollTop() < s.scrollSensitivity
                              ? (o = e(a).scrollTop(e(a).scrollTop() - s.scrollSpeed))
                              : e(window).height() - (t.pageY - e(a).scrollTop()) <
                                  s.scrollSensitivity &&
                                (o = e(a).scrollTop(e(a).scrollTop() + s.scrollSpeed))),
                          (s.axis && 'y' === s.axis) ||
                            (t.pageX - e(a).scrollLeft() < s.scrollSensitivity
                              ? (o = e(a).scrollLeft(e(a).scrollLeft() - s.scrollSpeed))
                    ...
                    drag: function (t, i, n) {
                      ...
                      for (d = n.snapElements.length - 1; d >= 0; d--)
                        ((h =
                          ...
                          (u =
                            (c = n.snapElements[d].top - n.margins.top) + n.snapElements[d].height),
                          v < l - g ||
                          m > h + g ||
                          b < c - g ||
                          y > u + g ||
                          !e.contains(n.snapElements[d].item.ownerDocument, n.snapElements[d].item)
                  ...
                  e.ui.plugin.add('draggable', 'stack', {
                    start: function (t, i, n) {
                      ...
                      r.length &&
                        ((s = parseInt(e(r[0]).css('zIndex'), 10) || 0),
                        e(r).each(function (t) {
                ...
                var r = (e.ui.intersect = (function () {
                  ...
                  return function (t, i, n, s) {
                    ...
                    switch (n) {
                      ...
                      case 'intersect':
                        return (
                          h < o + t.helperProportions.width / 2 &&
                      ...
                      case 'pointer':
                        return (
                          e(s.pageY, c, i.proportions().height) &&
                          e(s.pageX, h, i.proportions().width)
                        );
                      case 'touch':
                        return (
                          ((r >= c && r <= d) || (l >= c && l <= d) || (r < c && l > d)) &&
                          ((o >= h && o <= u) || (a >= h && a <= u) || (o < h && a > u))
                        );
                      default:
                        return !1;
                    }
                    ...
                    e: for (n = 0; n < o.length; n++)
                      if (
                        !(
                          ...
                          (t && !o[n].accept.call(o[n].element[0], t.currentItem || t.element))
                        )
                      ) {
                        ...
                        function () {
                          this.options &&
                            (!this.options.disabled &&
                              this.visible &&
                              r(t, this, this.options.tolerance, i) &&
                      ...
                      e.each(e.ui.ddmanager.droppables[t.options.scope] || [], function () {
                        if (!this.options.disabled && !this.greedyChild && this.visible) {
                          var n,
                            s,
                            o,
                            a = r(t, this, this.options.tolerance, i),
                          ...
                          l &&
                            (this.options.greedy &&
                              ...
                              (o = this.element.parents(':data(ui-droppable)').filter(function () {
                                ...
                                ((n = e(o[0]).droppable('instance')).greedyChild = 'isover' === l)),
                            n &&
                              'isover' === l &&
                  ...
                  e.widget('ui.resizable', e.ui.mouse, {
                    ...
                    _mouseCapture: function (t) {
                      ...
                      for (i in this.handles)
                        ((n = e(this.handles[i])[0]) === t.target || e.contains(n, t.target)) &&
                          (s = !0);
                    ...
                    _mouseStart: function (t) {
                      ...
                      return (
                        ...
                        o.containment &&
                          ((i += e(o.containment).scrollLeft() || 0),
                    ...
                    _mouseStop: function (t) {
                      ...
                      return (
                        this._helper &&
                          ...
                          h.animate || this.element.css(e.extend(r, { top: l, left: a })),
                  ...
                  e.ui.plugin.add('resizable', 'containment', {
                    ...
                    resize: function (t) {
                      ...
                      (d[0] !== document && /static/.test(d.css('position')) && (u = l),
                        h.left < (r._helper ? l.left : 0) &&
                          ((r.size.width =
                            r.size.width +
                            (r._helper ? r.position.left - l.left : r.position.left - u.left)),
                    ...
                    stop: function () {
                      ...
                      (t._helper &&
                        ...
                        e(this).css({ left: a.left - s.left - n.left, width: l, height: h }),
                        t._helper &&
                          !i.animate &&
                    ...
                    resize: function (t, i) {
                      ...
                      e(s.alsoResize).each(function () {
                        var t = e(this),
                          ...
                          s = {},
                          o = t.parents(i.originalElement[0]).length
                            ? ['width', 'height']
        ...
        !(function (t, i) {
          ...
          function S(e) {
            ...
            return (
              !v(e) &&
              !y(e) &&
              ('array' === i || 0 === t || ('number' == typeof t && t > 0 && t - 1 in e))
            );
          }
          ((E.fn = E.prototype =
            {
                  ...
                  if (null != (e = arguments[a]))
                    for (t in e)
                      ((n = e[t]),
                        '__proto__' !== t &&
                          r !== n &&
                          (h && n && (E.isPlainObject(n) || (s = Array.isArray(n)))
                            ? ((i = r[t]),
                              (o = s && !Array.isArray(i) ? [] : s || E.isPlainObject(i) ? i : {}),
                              (s = !1),
                              (r[t] = E.extend(h, o, n)))
                            : void 0 !== n && (r[t] = n)));
                return r;
            ...
            E.extend({
              ...
              makeArray: function (e, t) {
                ...
                return (
                  null != e &&
                    (S(Object(e)) ? E.merge(i, 'string' == typeof e ? [e] : e) : h.call(i, e)),
                  i
                );
              },
              ...
              map: function (e, t, i) {
                var n,
                  ...
                  o = 0,
                  r = [];
                if (S(e)) for (n = e.length; o < n; o++) null != (s = t(e[o], o, i)) && r.push(s);
          ...
          var k = (function (e) {
              ...
              if (!s && (d(t), (t = t || p), g)) {
                if (11 !== w && (u = Z.exec(e)))
                  if ((o = u[1])) {
                    ...
                    } else if (y && (h = y.getElementById(o)) && b(t, h) && h.id === o)
                      return (n.push(h), n);
                  } else {
                ...
                return r != p && 9 === r.nodeType && r.documentElement
                  ? ((f = (p = r).documentElement),
                    ...
                    w != p &&
                      ...
                      s.top !== s &&
                      (s.addEventListener
                        ? s.addEventListener('unload', oe, !1)
                        : s.attachEvent && s.attachEvent('onunload', oe)),
            ...
            (ae.matchesSelector = function (e, t) {
              if (
                (d(e),
                i.matchesSelector && g && !N[t + ' '] && (!v || !v.test(t)) && (!m || !m.test(t)))
              )
                try {
                  var n = y.call(e, t);
            ...
            (ae.attr = function (e, t) {
              ...
              var s = n.attrHandle[t.toLowerCase()],
                o = s && D.call(n.attrHandle, t.toLowerCase()) ? s(e, t, !g) : void 0;
              return void 0 !== o
                ? o
                : i.attributes || !g
                  ? e.getAttribute(t)
            ...
            (ae.uniqueSort = function (e) {
              var t,
                ...
                s = 0,
                o = 0;
              if (((u = !i.detectDuplicates), (c = !i.sortStable && e.slice(0)), e.sort(T), u)) {
                            ...
                            if (((f = [r ? m.firstChild : m.lastChild]), r && y)) {
                              for (
                                b =
                                  (p =
                                    (h =
                                      (c =
                                        (u = (d = m)[_] || (d[_] = {}))[d.uniqueID] ||
                                        (u[d.uniqueID] = {}))[e] || [])[0] === x && h[1]) && h[2],
                                  d = p && m.childNodes[p];
                              ...
                              (y &&
                                (b = p =
                                  (h =
                                    (c =
                                      (u = (d = t)[_] || (d[_] = {}))[d.uniqueID] ||
                                      (u[d.uniqueID] = {}))[e] || [])[0] === x && h[1]),
                              !1 === b)
                            )
                              for (
                                ;
                  ...
                  lang: he(function (e) {
                    return (
                      ...
                      function (t) {
                        ...
                        do {
                          if (
                            (i = g ? t.lang : t.getAttribute('xml:lang') || t.getAttribute('lang'))
                          )
                ...
                : function (t, i, l) {
                    ...
                    if (l) {
                      ...
                      for (; (t = t[n]); )
                        if (1 === t.nodeType || r)
                          if (
                            ((c = (u = t[_] || (t[_] = {}))[t.uniqueID] || (u[t.uniqueID] = {})),
                            s && s === t.nodeName.toLowerCase())
                          )
                            t = t[n] || t;
                          else {
                            if ((h = c[o]) && h[0] === x && h[1] === a) return (d[2] = h[2]);
                            if (((c[o] = d), (d[2] = e(t, i, l)))) return !0;
                          }
                    return !1;
                  };
            }
              ...
              return (
                ...
                he(function (o, r, a, l) {
                  var h,
                    ...
                    v = i ? (s || (o ? e : f || n) ? [] : r) : m;
                  if ((i && i(m, v, a, l), n))
                    for (h = xe(v, p), n(h, [], a, l), c = h.length; c--; )
                      (u = h[c]) && (v[p[c]] = !(m[p[c]] = u));
                  if (o) {
                    if (s || e) {
                      if (s) {
                      ...
                      for (c = v.length; c--; )
                        (u = v[c]) && (h = s ? M(o, u) : d[c]) > -1 && (o[h] = !(r[h] = u));
                    }
                  } else
                    ((v = xe(v === r ? v.splice(f, v.length) : v)),
                      s ? s(null, r, v, l) : A.apply(r, v));
                })
              );
            }
            function Ee(e) {
              for (
                var t,
                  ...
                  d = [
                    function (e, i, n) {
                      var s =
                        (!r && (n || i !== h)) || ((t = i).nodeType ? c(e, i, n) : u(e, i, n));
                      return ((t = null), s);
                    },
                  ];
                l < o;
            ...
            return (
                        ...
                        var i = t.length > 0,
                          ...
                          o = function (o, r, a, l, c) {
                            var u,
                              ...
                              S = C.length;
                            for (c && (h = r == p || r || c); y !== S && null != (u = C[y]); y++) {
                              if (s && u) {
                                for (
              ...
              (l = ae.select =
                function (e, t, i, s) {
                  ...
                  return (
                    (d || a(e, p))(s, t, !g, i, !t || (ee.test(e) && ve(t.parentNode)) || t),
                    i
                  );
                }),
          ...
          ((E.filter = function (e, t, i) {
            ...
            E.fn.extend({
              ...
              is: function (e) {
                return !!z(this, 'string' == typeof e && D.test(e) ? E(e) : e || [], !1).length;
              },
            }));
          var A,
            R = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
            ...
            if (((i = i || A), 'string' == typeof e)) {
              ...
              if (n[1]) {
                if (
                  ...
                  E.merge(this, E.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : b, !0)),
                  H.test(n[1]) && E.isPlainObject(t))
                )
              ...
              if (!D.test(e))
                for (; n < s; n++)
                  for (i = this[n]; i && i !== t; i = i.parentNode)
                    if (
                      i.nodeType < 11 &&
                      (r ? r.index(i) > -1 : 1 === i.nodeType && E.find.matchesSelector(i, e))
                    ) {
                      o.push(i);
                      break;
                    }
            ...
            E.each(
              {
                ...
                contents: function (e) {
                  return null != e.contentDocument && r(e.contentDocument)
                    ? e.contentDocument
                    : (P(e, 'template') && (e = e.content || e), E.merge([], e.childNodes));
                },
              },
              function (e, t) {
                E.fn[e] = function (i, n) {
                  ...
                  return (
                    ...
                    this.length > 1 && (O[e] || E.uniqueSort(s), M.test(e) && s.reverse()),
                    this.pushStack(s)
                  );
                };
              },
          ...
          ((E.Callbacks = function (e) {
            ...
            var t,
              ...
              h = {
                ...
                fireWith: function (e, i) {
                  return (
                    s || ((i = [e, (i = i || []).slice ? i.slice() : i]), r.push(i), t || l()),
                    this
                  );
                },
                fire: function () {
            ...
            E.extend({
                  ...
                  s = {
                    ...
                    then: function (e, i, s) {
                            ...
                            h = function () {
                              ...
                              if (!(e < o)) {
                                ...
                                ((h =
                                  ...
                                  v(h)
                                    ? s
                                      ? h.call(n, r(o, t, W, s), r(o, t, I, s))
                                      : (o++,
                                        h.call(
                                          n,
                                          r(o, t, W, s),
                                          r(o, t, I, s),
                                          r(o, t, W, t.notifyWith),
                                        ))
                                    : (i !== W && ((a = void 0), (l = [n])),
                                      (s || t.resolveWith)(a, l)));
                              }
                              ...
                              : function () {
                                  try {
                                    ...
                                    (E.Deferred.exceptionHook &&
                                      ...
                                      e + 1 >= o &&
                                        (i !== I && ((a = void 0), (l = [n])), t.rejectWith(a, l)));
                                  }
                                };
                          e
                            ? c()
                      ...
                      return E.Deferred(function (n) {
                        (t[0][3].add(r(0, n, v(s) ? s : W, n.notifyWith)),
                          t[1][3].add(r(0, n, v(e) ? e : W)),
                          t[2][3].add(r(0, n, v(i) ? i : I)));
                      }).promise();
                    },
                    promise: function (e) {
              ...
              when: function (e) {
                ...
                if (
                  t <= 1 &&
                  (U(e, o.done(r(i)).resolve, o.reject, !t),
                  'pending' === o.state() || v(s[i] && s[i].then))
                )
                  return o.then();
            ...
            E.extend({
              ...
              ready: function (e) {
                (!0 === e ? --E.readyWait : E.isReady) ||
                  ((E.isReady = !0), (!0 !== e && --E.readyWait > 0) || B.resolveWith(b, [E]));
              },
            }),
            (E.ready.then = B.then),
          ...
          var $ = function (e, t, i, n, s, o, r) {
              var a = 0,
                l = e.length,
                h = null == i;
              if ('object' === x(i)) for (a in ((s = !0), i)) $(e, t, a, i[a], !0, o, r);
              else if (
                void 0 !== n &&
                ((s = !0),
                v(n) || (r = !0),
          ...
          ((Q.uid = 1),
            (Q.prototype = {
              ...
              remove: function (e, t) {
                ...
                if (void 0 !== n) {
                  if (void 0 !== t) {
                    i = (t = Array.isArray(t) ? t.map(V) : (t = V(t)) in n ? [t] : t.match(L) || [])
                      .length;
                    for (; i--; ) delete n[t[i]];
                  }
            ...
            E.fn.extend({
              data: function (e, t) {
                ...
                if (void 0 === e) {
                  if (
                    this.length &&
                    ((s = Z.get(o)), 1 === o.nodeType && !J.get(o, 'hasDataAttrs'))
                  ) {
                    for (i = r.length; i--; )
                      r[i] &&
                        0 === (n = r[i].name).indexOf('data-') &&
                        ((n = V(n.slice(5))), ie(o, n, s[n]));
                ...
                return 'object' == typeof e
                  ...
                  : $(
                      ...
                      function (t) {
                        var i;
                        if (o && void 0 === t)
                          return void 0 !== (i = Z.get(o, e)) || void 0 !== (i = ie(o, e))
                            ? i
                            : void 0;
                        this.each(function () {
                          Z.set(this, e, t);
              ...
              queue: function (e, t, i) {
                ...
                if (e)
                  return (
                    ...
                    (n = J.get(e, t)),
                    i &&
                      (!n || Array.isArray(i) ? (n = J.access(e, t, E.makeArray(i))) : n.push(i)),
                    n || []
                  );
              },
            ...
            E.fn.extend({
              ...
              promise: function (e, t) {
                ...
                for ('string' != typeof e && ((t = e), (e = void 0)), e = e || 'fx'; r--; )
                  (i = J.get(o[r], e + 'queueHooks')) && i.empty && (n++, i.empty.add(a));
          ...
          function ce(e, t, i, n) {
            var s,
              ...
              c = e.nodeType && (E.cssNumber[t] || ('px' !== h && +l)) && se.exec(E.css(e, t));
            if (c && c[3] !== h) {
              for (l /= 2, h = h || c[3], c = +l || 1; r--; )
                (E.style(e, t, c + h),
                  (1 - o) * (1 - (o = a() / l || 0.5)) <= 0 && (r = 0),
                  (c /= o));
              ((c *= 2), E.style(e, t, c + h), (i = i || []));
            }
            return (
              i &&
                ((c = +c || +l || 0),
          ...
          function pe(e, t) {
            for (var i, n, s = [], o = 0, r = e.length; o < r; o++)
              (n = e[o]).style &&
                ...
                t
                  ? ('none' === i &&
                      ((s[o] = J.get(n, 'display') || null), s[o] || (n.style.display = '')),
                    '' === n.style.display && he(n) && (s[o] = de(n)))
                  : 'none' !== i && ((s[o] = 'none'), J.set(n, 'display', i)));
              ...
              (i =
                void 0 !== e.getElementsByTagName
                  ...
                  : void 0 !== e.querySelectorAll
                    ...
                    : []),
              void 0 === t || (t && P(e, t)) ? E.merge([e], i) : i
            );
          }
          function we(e, t) {
          ...
          function Ce(e, t, i, n, s) {
            for (
              var o, r, a, l, h, c, u = t.createDocumentFragment(), d = [], p = 0, f = e.length;
              p < f;
              p++
            )
              if ((o = e[p]) || 0 === o)
            ...
            for (u.textContent = '', p = 0; (o = d[p++]); )
              ...
              else if (((h = ae(o)), (r = _e(u.appendChild(o), 'script')), h && we(r), i))
                for (c = 0; (o = r[c++]); ) ye.test(o.type || '') && i.push(o);
            return u;
          }
          var Ee = /^key/,
          ...
          function He(e, t, i) {
            i
                  ...
                  handler: function (e) {
                    ...
                    if (1 & e.isTrigger && this[t]) {
                      if (o.length) (E.event.special[t] || {}).delegateType && e.stopPropagation();
                        ...
                        (n = i(this, t)),
                        this[t](),
                        o !== (s = J.get(this, t)) || n ? J.set(this, t, !1) : (s = {}),
                        o !== s)
                      )
              ...
              : void 0 === J.get(e, t) && E.event.add(e, t, Ne);
          }
          ((E.event = {
            global: {},
            ...
            dispatch: function (e) {
              ...
              if (
                ((l.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, l))
              ) {
                for (
                  r = E.event.handlers.call(this, l, h), t = 0;
                  ...
                  for (
                    ...
                    (l.rnamespace && !1 !== o.namespace && !l.rnamespace.test(o.namespace)) ||
                      ...
                      (l.data = o.data),
                      void 0 !==
                        (n = ((E.event.special[o.origType] || {}).handle || o.handler).apply(
                          s.elem,
                          a,
                        )) &&
                        !1 === (l.result = n) &&
            ...
            special: {
              ...
              click: {
                setup: function (e) {
                  var t = this || e;
                  return (me.test(t.type) && t.click && P(t, 'input') && He(t, 'click', Ne), !1);
                },
                trigger: function (e) {
                  var t = this || e;
                  return (me.test(t.type) && t.click && P(t, 'input') && He(t, 'click'), !0);
                },
                _default: function (e) {
                  var t = e.target;
                  return (
                    (me.test(t.type) && t.click && P(t, 'input') && J.get(t, 'click')) || P(t, 'a')
                  );
                },
              },
              beforeunload: {
          ...
          function Ie(e, t, i, n) {
            ...
            var s,
              ...
              f = t[0],
              g = v(f);
            if (g || (d > 1 && 'string' == typeof f && !m.checkClone && Ae.test(f)))
            ...
            if (
              d &&
              ((o = (s = Ce(t, e[0].ownerDocument, !1, e, n)).firstChild),
              1 === s.childNodes.length && (s = o),
              o || n)
            ) {
              for (a = (r = E.map(_e(s, 'script'), Oe)).length; u < d; u++)
                ((h = s),
                  u !== p && ((h = E.clone(h, !0, !0)), a && E.merge(r, _e(h, 'script'))),
                  i.call(e[u], h, u));
              if (a)
                for (c = r[r.length - 1].ownerDocument, E.map(r, je), u = 0; u < a; u++)
                  ((h = r[u]),
                    ye.test(h.type || '') &&
                      ...
                      (h.src && 'module' !== (h.type || '').toLowerCase()
                        ? E._evalUrl &&
                          !h.noModule &&
                          E._evalUrl(h.src, { nonce: h.nonce || h.getAttribute('nonce') }, c)
                        : w(h.textContent.replace(Re, ''), h, c)));
            }
            return e;
          }
          function Ue(e, t, i) {
            for (var n, s = t ? E.filter(t, e) : e, o = 0; null != (n = s[o]); o++)
              (i || 1 !== n.nodeType || E.cleanData(_e(n)),
                n.parentNode && (i && ae(n) && we(_e(n, 'script')), n.parentNode.removeChild(n)));
            return e;
          }
          (E.extend({
            ...
            clone: function (e, t, i) {
              ...
              if (!(m.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || E.isXMLDoc(e)))
                for (r = _e(a), n = 0, s = (o = _e(e)).length; n < s; n++) We(o[n], r[n]);
              if (t)
                if (i)
                  for (o = o || _e(e), r = r || _e(a), n = 0, s = o.length; n < s; n++)
                    Le(o[n], r[n]);
                else Le(e, a);
                  ...
                  function (e) {
                    ...
                    if (
                      ...
                      try {
                        for (; i < n; i++)
                          1 === (t = this[i] || {}).nodeType &&
                            (E.cleanData(_e(t, !1)), (t.innerHTML = e));
                        t = 0;
                      } catch (e) {}
                    }
              ...
              function (e, t) {
                E.fn[e] = function (e) {
                  for (var i, n = [], s = E(e), o = s.length - 1, r = 0; r <= o; r++)
                    ((i = r === o ? this : this.clone(!0)), E(s[r])[t](i), h.apply(n, i.get()));
          ...
          function Ge(e, t, i) {
            ...
            return (
              (i = i || Be(e)) &&
                ('' !== (r = i.getPropertyValue(t) || i[t]) || ae(e) || (r = E.style(e, t)),
                !m.pixelBoxStyles() &&
                  qe.test(r) &&
                  $e.test(t) &&
                  ((n = a.width),
            ...
            function e() {
              if (c) {
                ((h.style.cssText =
                  ...
                  re.appendChild(h).appendChild(c));
          ...
          function nt(e, t, i, n, s, o) {
            ...
            for (; r < 4; r += 2)
              ('margin' === i && (l += E.css(e, i + oe[r], !0, s)),
                n
                  ? ('content' === i && (l -= E.css(e, 'padding' + oe[r], !0, s)),
                    'margin' !== i && (l -= E.css(e, 'border' + oe[r] + 'Width', !0, s)))
                  : ((l += E.css(e, 'padding' + oe[r], !0, s)),
                    'padding' !== i
                      ? (l += E.css(e, 'border' + oe[r] + 'Width', !0, s))
                      : (a += E.css(e, 'border' + oe[r] + 'Width', !0, s))));
            return (
              !n &&
                o >= 0 &&
                (l +=
                  Math.max(
                    0,
                    Math.ceil(e['offset' + t[0].toUpperCase() + t.slice(1)] - o - l - a - 0.5),
                  ) || 0),
              l
            );
          }
          function st(e, t, i) {
            ...
            return (
              ...
              (r = parseFloat(r) || 0) + nt(e, t, i || (s ? 'border' : 'content'), o, n, r) + 'px'
            );
          }
            ...
            style: function (e, t, i, n) {
              if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var s,
                  ...
                  l = Ze.test(t),
                  h = e.style;
                if ((l || (t = Qe(a)), (r = E.cssHooks[t] || E.cssHooks[a]), void 0 === i))
          ...
          function pt(e, t, i) {
            for (
              var n, s = (ft.tweeners[t] || []).concat(ft.tweeners['*']), o = 0, r = s.length;
              o < r;
              o++
            )
          ...
          function ft(e, t, i) {
            var n,
              ...
              h = a.promise({
                ...
                stop: function (t) {
                  ...
                  return (
                    t
                      ? (a.notifyWith(e, [h, 1, 0]), a.resolveWith(e, [h, t]))
                      : a.rejectWith(e, [h, t]),
                    this
                  );
                },
            ...
            for (
              ...
              if ((n = ft.prefilters[o].call(h, e, c, h.opts)))
                return (
            ...
            return (
              E.map(c, pt, h),
              v(h.opts.start) && h.opts.start.call(e, h),
              h
                .progress(h.opts.progress)
                .done(h.opts.done, h.opts.complete)
                .fail(h.opts.fail)
                .always(h.opts.always),
              E.fx.timer(E.extend(l, { elem: e, anim: h, queue: h.opts.queue })),
              h
            );
          }
              ...
              function (e, t, i) {
                ...
                if ((l = !E.isEmptyObject(t)) || !E.isEmptyObject(p))
                  for (n in (u &&
                    ...
                    null == (h = m && m.display) && (h = J.get(e, 'display')),
            ...
            E.each(E.expr.match.bool.source.match(/\w+/g), function (e, t) {
              ...
              mt[t] = function (e, t, n) {
                var s,
                  ...
                  r = t.toLowerCase();
                return (
                  n || ((o = mt[r]), (mt[r] = s), (s = null != i(e, t, n) ? r : null), (mt[r] = o)),
                  s
                );
              };
            }));
              ...
              return arguments.length
                ? ((n = v(e)),
                  this.each(function (i) {
                    var s;
                    1 === this.nodeType &&
                      (null == (s = n ? e.call(this, i, E(this).val()) : e)
                        ? (s = '')
                        : 'number' == typeof s
                          ? (s += '')
                          : Array.isArray(s) &&
                ...
                : s
                  ? (t = E.valHooks[s.type] || E.valHooks[s.nodeName.toLowerCase()]) &&
                    'get' in t &&
                ...
                select: {
                  ...
                  set: function (e, t) {
                    for (var i, n, s = e.options, o = E.makeArray(t), r = s.length; r--; )
                      ((n = s[r]).selected = E.inArray(E.valHooks.option.get(n), o) > -1) &&
                        (i = !0);
            ...
            trigger: function (e, t, i, s) {
              ...
              if (
                ...
                3 !== i.nodeType &&
                  ...
                  (h = g.indexOf(':') < 0 && 'on' + g),
                  ((e = e[E.expando] ? e : new E.Event(g, 'object' == typeof e && e)).isTrigger = s
                    ? 2
                    : 3),
                  (e.namespace = m.join('.')),
                ...
                if (!s && !u.noBubble && !y(i)) {
                  for (
                    l = u.delegateType || g, Ct.test(l + g) || (r = r.parentNode);
                    r;
                    r = r.parentNode
                  )
                    (f.push(r), (a = r));
                ...
                for (o = 0; (r = f[o++]) && !e.isPropagationStopped(); )
                  ((d = r),
                    (e.type = o > 1 ? l : u.bindType || g),
                    (c =
                      (J.get(r, 'events') || Object.create(null))[e.type] && J.get(r, 'handle')) &&
                      c.apply(r, t),
                    (c = h && r[h]) &&
                      c.apply &&
                      K(r) &&
                      ((e.result = c.apply(r, t)), !1 === e.result && e.preventDefault()));
                return (
                  (e.type = g),
                  s ||
          ...
          E.parseXML = function (e) {
            ...
            return (
              (t && !t.getElementsByTagName('parsererror').length) || E.error('Invalid XML: ' + e),
              t
            );
          };
          var Tt = /\[\]$/,
          ...
          function zt(e, t, i, n) {
            ...
            if (Array.isArray(t))
              E.each(t, function (t, s) {
                i || Tt.test(e)
                  ? n(e, s)
                  : zt(e + '[' + ('object' == typeof s && null != s ? t : '') + ']', s, i, n);
              });
              ...
              ajax: function (e, t) {
                ...
                var i,
                  ...
                  C = {
                    ...
                    setRequestHeader: function (e, t) {
                      return (
                        null == h &&
                          ((e = w[e.toLowerCase()] = w[e.toLowerCase()] || e), (_[e] = t)),
                        this
                      );
                    },
                ...
                p.hasContent
                  ...
                  : ((d = p.url.slice(s.length)),
                    ...
                    !1 === p.cache &&
                      ((s = s.replace(Mt, '$1')),
                      (d = (Nt.test(s) ? '&' : '?') + '_=' + kt.guid++ + d)),
                    (p.url = s + d)),
                p.ifModified &&
                  (E.lastModified[s] && C.setRequestHeader('If-Modified-Since', E.lastModified[s]),
                  ...
                  h ||
                    ...
                    (_ = (function (e, t, i, n) {
                      var s,
                        ...
                        h = {},
                        c = e.dataTypes.slice();
                      if (c[1]) for (r in e.converters) h[r.toLowerCase()] = e.converters[r];
                      for (o = c.shift(); o; )
                        if (
                    ...
                    u
                      ? (p.ifModified &&
                          ((w = C.getResponseHeader('Last-Modified')) && (E.lastModified[s] = w),
                          (w = C.getResponseHeader('etag')) && (E.etag[s] = w)),
                        204 === e || 'HEAD' === p.type
                          ? (x = 'nocontent')
                          : 304 === e
                            ? (x = 'notmodified')
                            : ((x = _.state), (d = _.data), (u = !(b = _.error))))
                      : ((b = x), (!e && x) || ((x = 'error'), e < 0 && (e = 0))),
                    (C.status = e),
                    (C.statusText = (t || x) + ''),
                    u ? m.resolveWith(f, [d, x, C]) : m.rejectWith(f, [C, x, b]),
                    C.statusCode(y),
                    (y = void 0),
                    c && g.trigger(u ? 'ajaxSuccess' : 'ajaxError', [C, p, u ? d : b]),
                    v.fireWith(f, [C, x]),
                    c &&
          ...
          (E.ajaxSetup({
            ...
            E.ajaxPrefilter('json jsonp', function (e, t, i) {
              ...
              if (a || 'jsonp' === e.dataTypes[0])
                return (
                  ...
                  a
                    ? (e[a] = e[a].replace(Kt, '$1' + s))
                    : !1 !== e.jsonp && (e.url += (Nt.test(e.url) ? '&' : '?') + e.jsonp + '=' + s),
                  ...
                  i.always(function () {
                    (void 0 === o ? E(n).removeProp(s) : (n[s] = o),
                      e[s] && ((e.jsonpCallback = t.jsonpCallback), Vt.push(s)),
                      r && v(o) && o(r[0]),
                      (r = o = void 0));
                  }),
                  'script'
            ...
            (E.parseHTML = function (e, t, i) {
              return 'string' != typeof e
                ...
                : ('boolean' == typeof t && ((i = t), (t = !1)),
                  t ||
                    (m.createHTMLDocument
                      ? (((n = (t = b.implementation.createHTMLDocument('')).createElement(
                          'base',
            ...
            (E.fn.load = function (e, t, i) {
              var n,
                ...
                a = e.indexOf(' ');
              return (
                a > -1 && ((n = bt(e.slice(a))), (e = e.slice(0, a))),
                v(t) ? ((i = t), (t = void 0)) : t && 'object' == typeof t && (s = 'POST'),
                r.length > 0 &&
            ...
            E.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, function (e, t) {
              ...
              E.fn[e] = function (n) {
                return $(
                  ...
                  function (e, n, s) {
                    var o;
                    if ((y(e) ? (o = e) : 9 === e.nodeType && (o = e.defaultView), void 0 === s))
                      return o ? o[t] : e[n];
                ...
                if (
                  ...
                  ((i._touchStart = function (e) {
                    ...
                    (i._mouseInit = function () {
                      var t = this;
                      (e.support.mspointer && (t.element[0].style.msTouchAction = 'none'),
                        t.element.on({
