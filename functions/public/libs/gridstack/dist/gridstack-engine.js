...
class GridStackEngine {
    ...
    while ((collide = collide || this.collide(node, area, opt.skip))) {
      ...
      if (
        ...
        (node._moving &&
          ...
          (!this.collide(collide, Object.assign(Object.assign({}, collide), { y: node.y }), node) ||
            !this.collide(
              collide,
              Object.assign(Object.assign({}, collide), { y: nn.y - collide.h }),
              node,
            )))
      ) {
        ...
        moved = this.moveNode(
          node,
          Object.assign(Object.assign(Object.assign({}, nn), { y: collide.y + collide.h }), newOpt),
        );
        ...
        moved = this.moveNode(
          collide,
          Object.assign(
            Object.assign(Object.assign({}, collide), { y: nn.y + nn.h, skip: node }),
            newOpt,
          ),
        );
      }
  ...
  collide(skip, area = skip, skip2) {
    return this.nodes.find(
      (n) => n !== skip && n !== skip2 && utils_1.Utils.isIntercepted(n, area),
    );
  }
    ...
    if (nodes.length) {
      if (typeof layout === 'function') {
        ...
        nodes.forEach((node) => {
          ...
          node.x =
            column === 1 ? 0 : move ? Math.round(node.x * ratio) : Math.min(node.x, column - 1);
          node.w =
