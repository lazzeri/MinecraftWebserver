    ...
    var t = {
          ...
          ((e.GridStackDD = n),
            (o.GridStack.prototype._setupAcceptWidget = function () {
              if (this.opts.staticGrid || (!this.opts.acceptWidgets && !this.opts.removable))
                return (n.get().droppable(this.el, 'destroy'), this);
              let t,
                e,
                i,
                s = (s, o, l) => {
                ...
                n
                  ...
                  .droppable(this.el, {
                    accept: (t) => {
                      ...
                      if ((null == e ? void 0 : e.grid) === this) return !0;
                  ...
                  .on(this.el, 'dropover', (o, r, a) => {
                    ...
                    ((t = { top: d.top, left: d.left }),
                      ...
                      h.grid || ((h._isExternal = !0), (r.gridstackNode = h)),
                      (a = a || r));
                    ...
                    return (
                      h.grid && h.grid !== this
                        ? (r._gridstackNodeOrig || (r._gridstackNodeOrig = h),
                          (r.gridstackNode = h =
                            Object.assign(Object.assign({}, h), { w: g, h: p, grid: this })),
                  ...
                  .on(this.el, 'dropout', (t, e, i) => {
                    ...
                    return !!s && ((s.grid && s.grid !== this) || this._leave(e, i), !1);
                  })
                  .on(this.el, 'drop', (t, e, i) => {
                    ...
                    return (
                      ...
                      n.get().off(e, 'drag'),
                      i !== e
                        ? (i.remove(), (e.gridstackNode = l), o && (e = e.cloneNode(!0)))
                        : (e.remove(), n.get().remove(e)),
                      !!o &&
                        ((e.gridstackNode = s),
                        (s.el = e),
                        ...
                        this._gsEventHandler.dropped &&
                          this._gsEventHandler.dropped(
                            Object.assign(Object.assign({}, t), { type: 'dropped' }),
                            l && l.grid ? l : void 0,
                            s,
                          ),
                        window.setTimeout(() => {
                          s.el && s.el.parentElement
                            ? this._prepareDragDropByNode(s)
                            : this.engine.removeNode(s);
                        }),
                        !1))
                    );
                  }),
            ...
            (o.GridStack.prototype._prepareDragDropByNode = function (t) {
              ...
              if (
                ...
                return (
                  t._initDD && (i.remove(e), delete t._initDD),
              ...
              if (!t._initDD) {
                  ...
                  a = (s) => {
                    ...
                    if (o.gridstackNode && o.gridstackNode.grid === this) {
                      if (((t.el = o), t._isAboutToRemove)) {
                        ...
                        (t._temporaryRemoved
                          ? (r.Utils.removePositioningStyles(o),
                            r.Utils.copyPos(t, t._orig),
                            this._writePosAttr(o, t),
                            this.engine.addNode(t))
                ...
                (i
                  .draggable(e, { start: n, stop: a, drag: l })
                  .resizable(e, { start: n, stop: a, resize: l }),
                  (t._initDD = !0));
              }
              return (
                t.noMove || this.opts.disableDrag
                  ? (i.draggable(e, 'disable'), e.classList.add('ui-draggable-disabled'))
                  : (i.draggable(e, 'enable'), e.classList.remove('ui-draggable-disabled')),
                t.noResize || this.opts.disableResize
                  ? (i.resizable(e, 'disable'), e.classList.add('ui-resizable-disabled'))
                  : (i.resizable(e, 'enable'), e.classList.remove('ui-resizable-disabled')),
                this
              );
            }),
            ...
            (o.GridStack.prototype._dragOrResize = function (t, e, i, s, o, n) {
              ...
              if (
                ...
                ((a.x = Math.round(l / o)), (a.y = Math.round(c / n)));
                ...
                let d = i.position.left + h,
                  p = i.position.top + g;
                ((a.x = Math.round(d / o)), (a.y = Math.round(p / n)), (l = !0));
              }
              s._lastTried = a;
              let m = {
                x: i.position.left + h,
              ...
              return (
                this.opts.staticGrid ||
                  o.GridStack.getElements(t).forEach((t) => {
                    let i = t.gridstackNode;
                    i &&
                      (e ? delete i.noResize : (i.noResize = !0), this._prepareDragDropByNode(i));
                  }),
                this
              );
            }),
          ...
          class o {
            ...
            _fixCollisions(t, e = t, i, o = {}) {
              ...
              this._useEntireRowArea(t, e) &&
                ((r = { x: 0, w: this.column, y: e.y, h: e.h }), (i = this.collide(t, r, o.skip)));
              let n = !1,
                l = { nested: !0, pack: !1 };
              for (; (i = i || this.collide(t, r, o.skip)); ) {
                ...
                if (
                  ...
                  (t._moving &&
                    ...
                    e.y > t.y &&
                    !this.float &&
                    (!this.collide(i, Object.assign(Object.assign({}, i), { y: t.y }), t) ||
                      !this.collide(i, Object.assign(Object.assign({}, i), { y: e.y - i.h }), t)))
                    ? ((t._skipDown = t._skipDown || e.y > t.y),
                      (r = this.moveNode(
                        t,
                        Object.assign(Object.assign(Object.assign({}, e), { y: i.y + i.h }), l),
                      )),
                      i.locked && r
                        ? s.Utils.copyPos(e, t)
                        : !i.locked &&
                          r &&
                          o.pack &&
                          (this._packNodes(), (e.y = i.y + i.h), s.Utils.copyPos(t, e)),
                      (n = n || r))
                    : (r = this.moveNode(
                        i,
                        Object.assign(
                          Object.assign(Object.assign({}, i), { y: e.y + e.h, skip: t }),
                          l,
                        ),
                      )),
                  !r)
            ...
            collideCoverage(t, e, i) {
              ...
              return (
                ...
                i.forEach((t) => {
                  ...
                  (o.y < e.y
                    ? (i = (r.y + r.h - e.y) / e.h)
                    : o.y + o.h > e.y + e.h && (i = (e.y + e.h - r.y) / e.h),
                    o.x < e.x
                      ? (n = (r.x + r.w - e.x) / e.w)
                      : o.x + o.w > e.x + e.w && (n = (e.x + e.w - r.x) / e.w));
                  let a = Math.min(n, i);
                  a > l && ((l = a), (s = t));
                }),
                s
                ...
                this.batchMode ||
                  ...
                  this.float
                    ? this.nodes.forEach((t) => {
                        ...
                        for (; e > t._orig.y; )
                          (--e,
                            this.collide(t, { x: t.x, y: e, w: t.w, h: t.h }) ||
                              ((t._dirty = !0), (t.y = e)));
                      })
            ...
            prepareNode(t, e) {
              (((t = t || {})._id = t._id || o._idSeq++),
                (void 0 !== t.x && void 0 !== t.y && null !== t.x && null !== t.y) ||
                  (t.autoPosition = !0));
            ...
            getDirtyNodes(t) {
              return t
                ? this.nodes.filter((t) => t._dirty && !s.Utils.samePos(t, t._orig))
                : this.nodes.filter((t) => t._dirty);
            }
            _notify(t, e = !0) {
              if (this.batchMode) return this;
              let i = (t = void 0 === t ? [] : Array.isArray(t) ? t : [t]).concat(
                this.getDirtyNodes(),
              );
            ...
            removeAll(t = !0) {
              return (
                ...
                0 === this.nodes.length
                  ? this
                  : (t && this.nodes.forEach((t) => (t._removeDOM = !0)),
              ...
              let i,
                r = new o({
                  ...
                  nodes: this.nodes.map((e) =>
                    e === t ? ((i = Object.assign({}, e)), i) : Object.assign({}, e),
                  ),
                });
              if (!i) return !1;
              let n = r.moveNode(i, e);
              if (this.maxRow && n && ((n = r.getRow() <= this.maxRow), !n && !e.resizing)) {
            ...
            willItFit(t) {
              ...
              return (
                ...
                delete i.grid,
                e.addNode(i),
                e.getRow() <= this.maxRow && ((t._willFitPos = s.Utils.copyPos({}, i)), !0)
              );
            }
                  ...
                  this._layouts.forEach((e, i) => {
                    ...
                    if (i < this.column) this._layouts[i] = void 0;
                      ...
                      t.forEach((t) => {
                        ...
                        i &&
                          (t.y !== t._orig.y && (i.y += t.y - t._orig.y),
            ...
            updateNodeWidths(t, e, i, o = 'moveScale') {
              var r;
              if (!this.nodes.length || !e || t === e) return this;
              ...
              if (e > t) {
                ...
                !a.length &&
                  t !== s &&
                  (null === (r = this._layouts[s]) || void 0 === r ? void 0 : r.length) &&
                  ((t = s),
              ...
              if (
                (a.forEach((t) => {
                  ...
                  -1 !== e &&
                    ((i[e].x = t.x), (i[e].y = t.y), (i[e].w = t.w), n.push(i[e]), i.splice(e, 1));
                }),
                i.length)
              )
                if ('function' == typeof o) o(e, t, n, i);
                else if (!l) {
                  let s = e / t,
                  ...
                  (i.forEach((i) => {
                    ((i.x = 1 === e ? 0 : r ? Math.round(i.x * s) : Math.min(i.x, e - 1)),
                      (i.w =
                        1 === e || 1 === t ? 1 : l ? Math.round(i.w * s) || 1 : Math.min(i.w, e)),
                      n.push(i));
                  }),
                    (i = []));
                }
          ...
          class h {
            constructor(t, e = {}) {
              ((this._gsEventHandler = {}),
                (this._extraDragRow = 0),
                (this.el = t),
                (e = e || {}).row && ((e.minRow = e.maxRow = e.row), delete e.row));
              let i = n.Utils.toNumber(t.getAttribute('gs-row')),
                s = Object.assign(Object.assign({}, n.Utils.cloneDeep(a)), {
                  ...
                  draggable: {
                    handle:
                      (e.handleClass ? '.' + e.handleClass : e.handle ? e.handle : '') ||
              ...
              (t.getAttribute('gs-animate') &&
                (s.animate = n.Utils.toBool(t.getAttribute('gs-animate'))),
              ...
              if (
                ...
                this._isAutoCellHeight || 'initial' === this.opts.cellHeight
                  ...
                  : ('number' == typeof this.opts.cellHeight &&
                      ...
                      this.opts.cellHeightUnit !== a.cellHeightUnit &&
            ...
            static init(t = {}, e = '.grid-stack') {
              ...
              return i
                ? (i.gridstack || (i.gridstack = new h(i, n.Utils.cloneDeep(t))), i.gridstack)
                : ('string' == typeof e
                    ? console.error(
            ...
            static initAll(t = {}, e = '.grid-stack') {
              ...
              return (
                h.getGridElements(e).forEach((e) => {
                  (e.gridstack ||
                    ((e.gridstack = new h(e, n.Utils.cloneDeep(t))),
                    delete t.dragIn,
            ...
            addWidget(t, e) {
              ...
              ((e = n.Utils.cloneDeep(e) || {}), n.Utils.defaults(e, o));
              ...
              if (
                (i.forEach((e) => {
                  if (t && e.el && !e.subGrid) {
                    ...
                    ((e.content = t ? t.innerHTML : void 0), e.content || delete e.content);
                  } else (t || delete e.content, e.subGrid && (e.subGrid = e.subGrid.save(t, !0)));
                  delete e.el;
                }),
                e)
              ) {
            ...
            load(t, e = !0) {
              ...
              ((this._insertNotAppend = !0),
                this._prevColumn &&
                  ...
                  i.some((t) => t.x + t.w > this.opts.column) &&
                ...
                e &&
                  [...this.engine.nodes].forEach((t) => {
                    i.find((e) => t.id === e.id) ||
                      ('function' == typeof e
                        ? e(this, t, !1)
                        : (s.push(t), this.removeWidget(t.el, !0, !1)));
                  }),
                i.forEach((t) => {
                  let i =
                    t.id || 0 === t.id ? this.engine.nodes.find((e) => e.id === t.id) : void 0;
                  if (i) {
                    if ((this.update(i.el, t), t.subGrid && t.subGrid.children)) {
                      let e = i.el.querySelector('.grid-stack');
                      e &&
                        e.gridstack &&
                        (e.gridstack.load(t.subGrid.children), (this._insertNotAppend = !0));
                    }
                  } else
                    e &&
                      (t =
                        'function' == typeof e
                          ? e(this, t, !0).gridstackNode
                          : this.addWidget(t).gridstackNode);
                }),
            ...
            update(t, e) {
              ...
              return (
                h.getElements(t).forEach((t) => {
                  ...
                  (o &&
                    (this.engine.cleanNodes().beginUpdate(i).moveNode(i, o),
                    this._updateContainerHeight(),
                    this._triggerChangeEvent(),
                    this.engine.endUpdate()),
            ...
            _removeStylesheet() {
              return (
                this._styles && (n.Utils.removeStylesheet(this._styles._id), delete this._styles),
                this
              );
            }
            _updateStyles(t = !1, e) {
              ...
              if (!this._styles) {
                ...
                if (((this._styles = n.Utils.createStylesheet(t, e)), !this._styles)) return this;
                ((this._styles._id = t),
                  (this._styles._max = 0),
            ...
            _setStaticClass() {
              ...
              return (
                this.opts.staticGrid
                  ? (this.el.classList.add(...t), this.el.setAttribute('gs-static', 'true'))
                  : (this.el.classList.remove(...t), this.el.removeAttribute('gs-static')),
                this
              );
            }
            onParentResize() {
                ...
                this._isAutoCellHeight &&
                  (!e && this.opts.cellHeightThrottle
                    ? (this._cellHeightThrottle ||
                        (this._cellHeightThrottle = n.Utils.throttle(
                          () => this.cellHeight(),
        ...
        311: (t, e, i) => {
          ...
          class n extends r.DDBaseImplement {
            ...
            _dragStart(t) {
              ...
              (this.helper !== this.el
                ? (this._setupDragFollowNodeNotifyStart(e), this._dragFollow(t))
            ...
            _createHelper(t) {
              ...
              return (
                'function' == typeof this.option.helper
                  ...
                  : 'clone' === this.option.helper && (e = o.DDUtils.clone(this.el)),
                document.body.contains(e) ||
                  o.DDUtils.appendTo(
                    e,
                    'parent' === this.option.appendTo ? this.el.parentNode : this.option.appendTo,
                  ),
                e === this.el &&
                  (this.dragElementOriginStyle = n.originStyleProp.map((t) => this.el.style[t])),
                e
              );
            }
            _setupHelperStyle() {
        ...
        54: (t, e, i) => {
          ...
          class n extends o.DDBaseImplement {
            ...
            updateOption(t) {
              return (
                Object.keys(t).forEach((e) => (this.option[e] = t[e])),
                this._setupAccept(),
                this
              );
            }
            ...
            _canDrop() {
              return (
                s.DDManager.dragElement && (!this.accept || this.accept(s.DDManager.dragElement.el))
              );
            }
            _setupAccept() {
              return (
                this.option.accept && 'string' == typeof this.option.accept
                  ? (this.accept = (t) => t.matches(this.option.accept))
            ...
            setupDraggable(t) {
              return (
                this.ddDraggable
                  ...
                  : (this.ddDraggable = new o.DDDraggable(this.el, t)),
                this
              );
            }
            cleanDraggable() {
            ...
            setupResizable(t) {
              return (
                this.ddResizable
                  ...
                  : (this.ddResizable = new s.DDResizable(this.el, t)),
                this
              );
            }
            cleanResizable() {
        ...
        97: (t, e, i) => {
          ...
          class l extends o.DDBaseImplement {
            ...
            updateOption(t) {
              ...
              return (
                Object.keys(t).forEach((e) => (this.option[e] = t[e])),
                e && (this._removeHandlers(), this._setupHandlers()),
            ...
            _getChange(t, e) {
              ...
              (e.indexOf('e') > -1
                ? (s.width += o)
                : e.indexOf('w') > -1 && ((s.width -= o), (s.left += o)),
                e.indexOf('s') > -1
                  ? (s.height += r)
                  : e.indexOf('n') > -1 && ((s.height -= r), (s.top += r)));
              const n = this._constrainSize(s.width, s.height);
              return (
                Math.round(s.width) !== Math.round(n.width) &&
                  (e.indexOf('w') > -1 && (s.left += s.width - n.width), (s.width = n.width)),
                Math.round(s.height) !== Math.round(n.height) &&
                  (e.indexOf('n') > -1 && (s.top += s.height - n.height), (s.height = n.height)),
                s
              );
            }
            _constrainSize(t, e) {
              ...
              return (
                this._getDDElements(t).forEach((t) => {
                  if ('disable' === e || 'enable' === e) t.ddResizable && t.ddResizable[e]();
                    ...
                    let s = t.el.getAttribute('gs-resize-handles')
                      ? t.el.getAttribute('gs-resize-handles')
                      : i.opts.resizable.handles;
                    t.setupResizable(
                      Object.assign(
                        Object.assign(Object.assign({}, i.opts.resizable), { handles: s }),
                        { start: e.start, stop: e.stop, resize: e.resize },
                      ),
                    );
                  }
                }),
            ...
            droppable(t, e, i, s) {
              return (
                'function' != typeof e.accept ||
                  e._accept ||
                  ((e._accept = e.accept), (e.accept = (t) => e._accept(t))),
                this._getDDElements(t).forEach((t) => {
                  'disable' === e || 'enable' === e
              ...
              return (
                this._getDDElements(t).forEach((t) =>
                  t.on(e, (t) => {
                    i(
                      t,
                      r.DDManager.dragElement ? r.DDManager.dragElement.el : t.target,
                      r.DDManager.dragElement ? r.DDManager.dragElement.helper : null,
                    );
                  }),
                ),
                this
        ...
        593: (t, e) => {
          (Object.defineProperty(e, '__esModule', { value: !0 }),
            ...
            (e.obsoleteOptsDel = function (t, e, i, s) {
              void 0 !== t[e] &&
                console.warn('gridstack.js: Option `' + e + '` is deprecated in ' + i + s);
            }),
          ...
          class i {
            ...
            static sort(t, e, i) {
              return (
                (i = i || t.reduce((t, e) => Math.max(e.x + e.w, t), 0) || 12),
                -1 === e
                  ? t.sort((t, e) => e.x + e.y * i - (t.x + t.y * i))
                  : t.sort((t, e) => t.x + t.y * i - (e.x + e.y * i))
              );
            }
              ...
              if (s.top < 0 || s.bottom > o) {
                ...
                if (null !== l) {
                  ...
                  (s.top < 0 && i < 0
                    ? t.offsetHeight > o
                      ? (l.scrollTop += i)
                      : (l.scrollTop += Math.abs(n) > Math.abs(i) ? i : n)
                    : i > 0 &&
                      (t.offsetHeight > o ? (l.scrollTop += i) : (l.scrollTop += r > i ? i : r)),
                    (e.top += l.scrollTop - a));
                }
              }
            }
            static updateScrollResize(t, e, i) {
              ...
              n < i
                ...
                : l && s.scrollBy({ behavior: 'smooth', top: i - (o - n) });
            }
            static clone(t) {
