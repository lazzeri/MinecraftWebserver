          ...
          class o {
            ...
            _fixCollisions(t, e = t, i, o = {}) {
              ...
              this._useEntireRowArea(t, e) &&
                ((n = { x: 0, w: this.column, y: e.y, h: e.h }), (i = this.collide(t, n, o.skip)));
              let r = !1,
                l = { nested: !0, pack: !1 };
              for (; (i = i || this.collide(t, n, o.skip)); ) {
                let n;
                if (
                  (i.locked ||
                  (t._moving &&
            ...
            collideCoverage(t, e, i) {
              ...
              return (
                ...
                i.forEach((t) => {
                  ...
                  (o.y < e.y
                    ? (i = (n.y + n.h - e.y) / e.h)
                    : o.y + o.h > e.y + e.h && (i = (e.y + e.h - n.y) / e.h),
                    o.x < e.x
                      ? (r = (n.x + n.w - e.x) / e.w)
                      : o.x + o.w > e.x + e.w && (r = (e.x + e.w - n.x) / e.w));
                  let h = Math.min(r, i);
                  h > l && ((l = h), (s = t));
                }),
                s
            ...
            addNode(t, e = !1) {
              ...
              if (
                ...
                for (let e = 0; ; ++e) {
                  ...
                  let n = { x: i, y: o, w: t.w, h: t.h };
                  if (!this.nodes.find((t) => s.Utils.isIntercepted(n, t))) {
            ...
            moveNodeCheck(t, e) {
              ...
              if (!i) return !1;
              let r = n.moveNode(i, e);
              if (this.maxRow && r && ((r = n.getRow() <= this.maxRow), !r && !e.resizing)) {
            ...
            moveNode(t, e) {
              ...
              if (
                ...
                return !1;
              let n = s.Utils.copyPos({}, t),
                r = o,
                l = this.collideAll(t, r, e.skip),
                h = !0;
              if (l.length) {
                let i = t._moving && !e.nested ? this.collideCoverage(t, e, l) : l[0];
                h = !!i && !this._fixCollisions(t, o, i, e);
              }
              return (
                h && ((t._dirty = !0), s.Utils.copyPos(t, o)),
            ...
            save(t = !0) {
              ...
              return (
                ...
                this.nodes.forEach((e) => {
                  ...
                  for (let t in n)
                    ('_' !== t[0] && null !== n[t] && void 0 !== n[t]) || delete n[t];
                  (delete n.grid,
                    t || delete n.el,
                    n.autoPosition || delete n.autoPosition,
                    n.noResize || delete n.noResize,
                    n.noMove || delete n.noMove,
                    n.locked || delete n.locked,
                    o.push(n));
                }),
                o
              );
            ...
            updateNodeWidths(t, e, i, o = 'moveScale') {
              ...
              if (
                (h.forEach((t) => {
                  ...
                  -1 !== e &&
                    ((i[e].x = t.x), (i[e].y = t.y), (i[e].w = t.w), r.push(i[e]), i.splice(e, 1));
                }),
                i.length)
              )
                if ('function' == typeof o) o(e, t, r, i);
                else if (!l) {
                  let s = e / t,
                    n = 'move' === o || 'moveScale' === o,
                    l = 'scale' === o || 'moveScale' === o;
                  (i.forEach((i) => {
                    ((i.x = 1 === e ? 0 : n ? Math.round(i.x * s) : Math.min(i.x, e - 1)),
                      (i.w =
          ...
          class a {
            constructor(t, e = {}) {
              ...
              let i = r.Utils.toNumber(t.getAttribute('gs-row')),
                s = Object.assign(Object.assign({}, r.Utils.cloneDeep(h)), {
              ...
              (t.getAttribute('gs-animate') &&
                (s.animate = r.Utils.toBool(t.getAttribute('gs-animate'))),
              ...
              let o = r.Utils.closestByClass(this.el, h.itemClass);
              if (
                (o &&
                  o.gridstackNode &&
            ...
            static init(t = {}, e = '.grid-stack') {
              ...
              return i
                ? (i.gridstack || (i.gridstack = new a(i, r.Utils.cloneDeep(t))), i.gridstack)
                : ('string' == typeof e
                    ? console.error(
            ...
            static initAll(t = {}, e = '.grid-stack') {
              ...
              return (
                a.getGridElements(e).forEach((e) => {
                  (e.gridstack ||
                    ((e.gridstack = new a(e, r.Utils.cloneDeep(t))),
                    delete t.dragIn,
            ...
            addWidget(t, e) {
              ...
              ((e = r.Utils.cloneDeep(e) || {}), r.Utils.defaults(e, o));
            ...
            save(t = !0, e = !1) {
              ...
              if (
                ...
                let t = r.Utils.cloneDeep(this.opts);
                return (
                  ...
                  r.Utils.removeInternalAndSame(t, h),
                  (t.children = i),
                  t
                );
              }
              ...
              return (
                a.getElements(t).forEach((t) => {
                  ...
                  let i = t.gridstackNode,
                    s = r.Utils.cloneDeep(e);
                  delete s.autoPosition;
                  let o,
                    n = ['x', 'y', 'w', 'h'];
                  if (
                    (n.some((t) => void 0 !== s[t] && s[t] !== i[t]) &&
                      ((o = {}),
                      n.forEach((t) => {
                  ...
                  (o &&
                    ...
                    h && this._prepareDragDropByNode(i));
                }),
                this
              );
            }
            ...
            _updateStyles(t = !1, e) {
              ...
              if (!this._styles) {
                ...
                ((this._styles._id = t),
                  (this._styles._max = 0),
                  r.Utils.addCSSRule(this._styles, o, `min-height: ${i}${s}`));
                ...
                (r.Utils.addCSSRule(
                  ...
                  r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-ne`, `right: ${h}`),
                  r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-e`, `right: ${h}`),
                  r.Utils.addCSSRule(
                    this._styles,
                    `${o} > .ui-resizable-se`,
                    `right: ${h}; bottom: ${l}`,
                  ),
                  r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-nw`, `left: ${a}`),
                  r.Utils.addCSSRule(this._styles, `${o} > .ui-resizable-w`, `left: ${a}`),
                  r.Utils.addCSSRule(
                    this._styles,
                    `${o} > .ui-resizable-sw`,
                    `left: ${a}; bottom: ${l}`,
            ...
            _prepareElement(t, e = !1, i) {
              ...
              return (
                ...
                r.Utils.same(i, s) || this._writeAttr(t, i),
            ...
            _onStartMoving(t, e, i, s, o, n) {}
            _dragOrResize(t, e, i, s, o, n) {}
            _leave(t, e) {}
          }
          ((e.GridStack = a), (a.Utils = r.Utils), (a.Engine = n.GridStackEngine));
        },
        699: (t, e) => {
          Object.defineProperty(e, '__esModule', { value: !0 });
        },
              ...
              if (s.top < 0 || s.bottom > o) {
                ...
                if (null !== l) {
                  ...
                  (s.top < 0 && i < 0
                    ...
                    : i > 0 &&
                      (t.offsetHeight > o ? (l.scrollTop += i) : (l.scrollTop += n > i ? i : n)),
                    (e.top += l.scrollTop - h));
                }
              }
            }
